...
echo"{$row['firstname']} {$row['lastname']} <br> {$row['street']} {$row['house_nr']} <br> {$row['zip']} {$row['location']}  ";
Echo"</td>";
Echo"<td valign='top' width=10% style='background-color: white;'>";
echo "<img src=";
...
echo "<td valign='top'> </td>";
Echo"<td height='15px' width=10% > Stundenlohn:</td>";
Echo"<td height='15px' colspan='2'><span style='background-color: white;'>{$row['price_per_hour']} Fr.</span></td>";

Echo"<td align='left' height='15px' colspan='2' width=50% ><a href='feedback.php?s=0&id=$id' ><img height='30' width='50' src='images/thump.jpg'></a></td>";
...
<table class="sub2" style="float: left; margin-left: 30px;"> 
	    ...
	    <tr>
	      <td valign="top">
            <div id="TabbedPanels1" class="TabbedPanels" style="position:relative; top:-3px; height:300px;">
