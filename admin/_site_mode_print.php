...
$layout->blocks["top"][] = "pdf";$page_layouts["_site_mode_print"] = $layout;
...
//	Message - 
			$record["Message_value"] = $pageObject->showDBValue("Message", $data, $keylink);
			$record["Message_class"] = $pageObject->fieldClass("Message");
//	Mode - 
			$record["Mode_value"] = $pageObject->showDBValue("Mode", $data, $keylink);
			$record["Mode_class"] = $pageObject->fieldClass("Mode");
//	ID - 
...
$xt->assign("Message_fieldheadercolumn",true);
$xt->assign("Message_fieldheader",true);
$xt->assign("Message_fieldcolumn",true);
$xt->assign("Message_fieldfootercolumn",true);
$xt->assign("Mode_fieldheadercolumn",true);
$xt->assign("Mode_fieldheader",true);
$xt->assign("Mode_fieldcolumn",true);
$xt->assign("Mode_fieldfootercolumn",true);
