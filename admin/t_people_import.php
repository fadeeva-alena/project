...
// keys array
$keys[]=AddFieldWrappers("people_id");
$keys_present=1;
...
$layout = new TLayout("import","BoldAqua","MobileAqua");
...
$layout->blocks["top"][] = "import";$page_layouts["t_people_import"] = $layout;
...
$xt->display("t_people_import.htm");
