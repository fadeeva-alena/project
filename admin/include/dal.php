...
class tDAL
{
	...
	function FillTablesList()
	{
		if($this->lstTables)
			return;
	  $this->lstTables[]=array("name"=>"_taccess","varname"=>"_taccess");
	  $this->lstTables[]=array("name"=>"_site_mode","varname"=>"_site_mode");
	  $this->lstTables[]=array("name"=>"t_log","varname"=>"t_log");
	  $this->lstTables[]=array("name"=>"_t_search","varname"=>"_t_search");
	  $this->lstTables[]=array("name"=>"t_people","varname"=>"t_people");
	  $this->lstTables[]=array("name"=>"t_skills","varname"=>"t_skills");
	  $this->lstTables[]=array("name"=>"t_needs","varname"=>"t_needs");
	  $this->lstTables[]=array("name"=>"t_zipch","varname"=>"t_zipch");
	  $this->lstTables[]=array("name"=>"t_skill_types","varname"=>"t_skill_types");
	  $this->lstTables[]=array("name"=>"t_skill_subtype","varname"=>"t_skill_subtype");
	}
