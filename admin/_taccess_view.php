...
$layout->blocks["top"][] = "details";$page_layouts["_taccess_view"] = $layout;
...
$arr = array();
$arr['fName'] = "Start";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("Start");
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "End";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("End");
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "Note";
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='_taccess_edit.php?".$editlink."'\"");
