...
$layout->blocks["top"][] = "details";$page_layouts["_site_mode_view"] = $layout;
...
$arr = array();
$arr['fName'] = "Message";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("Message");
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "Mode";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("Mode");
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "ID";
...
//Message - 
	...
	if($mainTableOwnerID=="Message")
		$ownerIdValue=$value;
	$xt->assign("Message_value",$value);
...
//Mode - 
	...
	if($mainTableOwnerID=="Mode")
		$ownerIdValue=$value;
	$xt->assign("Mode_value",$value);
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='_site_mode_edit.php?".$editlink."'\"");
