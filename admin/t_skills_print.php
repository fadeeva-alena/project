...
$layout->blocks["top"][] = "pdf";$page_layouts["t_skills_print"] = $layout;
...
//	skill_id - 
			$record["skill_id_value"] = $pageObject->showDBValue("skill_id", $data, $keylink);
			$record["skill_id_class"] = $pageObject->fieldClass("skill_id");
//	people_id - 
...
//	skill_type_id - 
			$record["skill_type_id_value"] = $pageObject->showDBValue("skill_type_id", $data, $keylink);
			$record["skill_type_id_class"] = $pageObject->fieldClass("skill_type_id");
//	skill_subtype_id - 
			$record["skill_subtype_id_value"] = $pageObject->showDBValue("skill_subtype_id", $data, $keylink);
			$record["skill_subtype_id_class"] = $pageObject->fieldClass("skill_subtype_id");
//	skill_note - 
			$record["skill_note_value"] = $pageObject->showDBValue("skill_note", $data, $keylink);
			$record["skill_note_class"] = $pageObject->fieldClass("skill_note");
//	skill_hourly - 
			$record["skill_hourly_value"] = $pageObject->showDBValue("skill_hourly", $data, $keylink);
			$record["skill_hourly_class"] = $pageObject->fieldClass("skill_hourly");
//	prof_provider - 
...
$xt->assign("skill_id_fieldheadercolumn",true);
$xt->assign("skill_id_fieldheader",true);
$xt->assign("skill_id_fieldcolumn",true);
$xt->assign("skill_id_fieldfootercolumn",true);
...
$xt->assign("skill_type_id_fieldheadercolumn",true);
$xt->assign("skill_type_id_fieldheader",true);
$xt->assign("skill_type_id_fieldcolumn",true);
$xt->assign("skill_type_id_fieldfootercolumn",true);
$xt->assign("skill_subtype_id_fieldheadercolumn",true);
$xt->assign("skill_subtype_id_fieldheader",true);
$xt->assign("skill_subtype_id_fieldcolumn",true);
$xt->assign("skill_subtype_id_fieldfootercolumn",true);
$xt->assign("skill_note_fieldheadercolumn",true);
$xt->assign("skill_note_fieldheader",true);
$xt->assign("skill_note_fieldcolumn",true);
$xt->assign("skill_note_fieldfootercolumn",true);
$xt->assign("skill_hourly_fieldheadercolumn",true);
$xt->assign("skill_hourly_fieldheader",true);
$xt->assign("skill_hourly_fieldcolumn",true);
$xt->assign("skill_hourly_fieldfootercolumn",true);
