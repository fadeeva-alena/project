...
class ImageManipulation {
	...
	{/* change ImageCreateTrueColor to ImageCreate if your GD not supported ImageCreateTrueColor function*/
		if ( isset($this->image["sizex_thumb"]) && isset($this->image["sizey_thumb"]) ) {		
			$this->image["des"] = ImageCreate($this->image["sizex_thumb"], $this->image["sizey_thumb"]);
			...
			$tmpImage = ImageCreate($this->image["sizex"], $this->image["sizey"]);
			...
			$this->image["des"] = ImageCreate($this->image["sizex"], $this->image["sizey"]);
