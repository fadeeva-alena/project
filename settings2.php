...
if($_POST["nextbtn"] == "Speichern und weiter zum Angebotsprofil (3 von 6)" )
{
...
<div id ="contentIndex">
	<h1 id="title">2) Zeitliche Verfügbarkeit:  <img src="images/page2.png" border="0"  usemap="#green" align="right" /></h1>
	<map name="green">
		<area shape="rect" title="Persönliche Daten" coords="5,2,35,30" href="javascript:Nav(1);" >
	...
	<form method="post" name="form1" action="settings2.php">
	    ...
	    <tr>
	      	<td width="435">
	      		<label id="smal">aktiver Zeitplan:
...
?>
                ...
                <div class="TabbedPanelsContent">
                  	<p>
                        ...
                        <input type="text" name="start" id="start" Value="<?php echo"$row[temp_sched_from]"; ?>" /><br/>
	                    <label style="width: 50px;">Ende:</label>
...
?>
				  	...
				  	<td>
				      	<div style="margin-left:12px;margin-top:30px; color:#23527c; font-size:14px;">
		    ...
		    <p><input type="submit" name="nextbtn" id="nextbtn" class="form-control btn btn-primary" value="Speichern und weiter zum Angebotsprofil (3 von 6)" onclick=location.href="settings3.php" /></p>
		</form>
	</div>
</div>
<script type="text/javascript">
