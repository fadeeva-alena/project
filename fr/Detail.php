...
echo"<td width='30%' height='15'> Nom, Adresse: </td>";
echo"<td colspan='4' height='15'> Contact (en gras=préféré):</td>";
...
Echo"<tr>";
Echo"<td height='15px'> Salaire horaire:</td>";
...
echo"<td style='vertical-align:top;'> Rq. </td>";
	      ...
	      <td valign="top">
            <div id="TabbedPanels1" class="TabbedPanels" style="position:relative; top:-2px;">
              <ul class="TabbedPanelsTabGroup">
                <li class="TabbedPanelsTab" tabindex="0">Disponibilités</li>
                <li class="TabbedPanelsTab" tabindex="0">Informations</li>
              </ul>
                ...
                <div class="TabbedPanelsContent" style="height:247px;">
                 <table border="0" cellpadding="0" cellspacing="0" vspace="0">
                    <tr style="background:#56769d;" >
                      <td ></td>
                       <td ><font size="2px" Color="White">Lu</font></td>
                        <td ><font size="2px"Color="White">Ma</font></td>
<td ><font size="2px" Color="White">Me</font></td>
<td ><font size="2px"Color="White">Je</font></td>
<td ><font size="2px"Color="White">Ve</font></td>
...
?>
     ...
     <tr><td><div id="slider"><div id="slidertext1">Je suis à l'heure,<br />sinon je préviens par téléphone.</div></td><td><div id="sliderframe"><IFRAME src="slider/slider.php?SCALE=<?php echo"{$row['psych_time_loose_tight']}"; ?> " height="40px" width="50px" frameborder=0></IFRAME></div></td><td><div id="slidertext2">Il peut m'arriver d'avoir<br />quelques minutes de retard.</div></div></td></tr>
    <tr><td><div id="slider"><div id="slidertext1">J'accomplis mon travail<br />exactement comme demandé.</div></td><td><div id="sliderframe"><IFRAME src="slider/slider.php?SCALE=<?php echo"{$row['psych_exact_creativ']}"; ?>" height="40px" width="50px" frameborder=0></IFRAME></div></td><td><div id="slidertext2">Je trouve des solutions<br />quand c'est nécessaire.</div></div></td></tr>
    <tr><td><div id="slider"><div id="slidertext1">J'ai un grand<br />coeur.</div></td><td><div id="sliderframe"><IFRAME src="slider/slider.php?SCALE=<?php echo"{$row['psych_heart_thing']}"; ?>" height="40px" width="50px" frameborder=0></IFRAME></div></td><td><div id="slidertext2">Je suis pragmatique <br />et astucieux.</div></div></td></tr>
    <tr><td><div id="slider"><div id="slidertext1">Je me sens bien quelque <br />soit la situation.</div></td><td><div id="sliderframe"><IFRAME src="slider/slider.php?SCALE=<?php echo"{$row['psych_easy_security']}"; ?>" height="40px" width="50px" frameborder=0></IFRAME></div></td><td><div id="slidertext2">J'ai clairement besoin<br />d'être cadré.</div></div></td></tr>
    <tr><td><div id="slider"><div id="slidertext1">Je désamorce<br />les conflits.</div></td><td><div id="sliderframe"><IFRAME src="slider/slider.php?SCALE=<?php echo"{$row['psych_conflict_take_leave']}"; ?>" height="40px" width="50px" frameborder=0></IFRAME></div></td><td><div id="slidertext2">J'évite les conflits <br />si possible.</div></div></td></tr>
</Table>
                </div>
              </div>
          </div></td>
