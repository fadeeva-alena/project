...
$prof_prov = 0;
if($_POST['Gechleht'] == "Masculin") 
    $gen = 2;
if($_POST['Gechleht'] == "Féminin") 
    $gen = 1;
...
if($_POST["nextbtn"] == "Valider et la suite selon vos dispositions (2 sur 6)")
...
<input type=button value="Infos Légales" onclick=location.href="Rechtliches.php" id="helpbtn4">
  ...
  <div class="mainContent">
	<div class="content">
		<span id="title">1) Données personnelles <img src="../images/page.png" align="right" /></span>
...
<table class="settings_tbl">
  ...
  <tr>
    <td colspan="5">Association, Organisation ou Institution publique: <?php if($prof_prov == 1) echo"<input type='checkbox' name='prov' checked  tabindex='2'>"; else echo"<input type='checkbox' name='prov' tabindex='2' >"; ?></td>
  </tr>
  <tr>
    <td>Prénom:</td>
    <td>
  ...
  <tr>
    ...
    <td><div style="position:relative;"><div id="date" style="position:absolute; top:-30px; left:0px; width:300px; color:#fff; display:none;">Votre date de naissance ne sera pas publiée.<br />Nous pourrons l'utiliser par exemple<br />pour vérifier votre identité si <br/>vous nous téléphonez <br/> (Authentification).</div></div></td>
  </tr>
  <tr>
...
?>
      ...
      <div  style="text-align:center; overflow:hidden; width:72px; height:24px; border:none; background:url(images/button_bg.gif) top left no-repeat;">
         <div  tabindex="7"  name="d1" id="d1"   style="color:#000; font-size:12px; padding:5px 0px 0px 0px;">Charger</div>
      ...
      <td><div style="position:relative;"><div id="avatar" style="position:absolute; top:-30px; left:0px; width:300px; color:#fff; display:none;">Une belle photo permettra de vous <br/>faire plus facilement confiance <br/>si vous n'êtes pas connu,<br/>  et vous serez identifié plus facilement <br/>si votre nom n'est pas connu <br/>(Obligatoire).</div></div></td>
  </tr>
  <tr>
    <td>Rue/N°</td>
    <td colspan="4">
  ...
  <tr>
    ...
    <td><div style="position:relative;"><div id="handy1" style="position:absolute; top:-25px; left:0px; width:300px; color:#fff; display:none;">Le numéro de mobile est obligatoire.<br />Si vous oubliez votre mot de passe<br />il sera renvoyé par SMS.</div></div></td>
  </tr>
  <tr>
    <td>E-mail:</td>
  ...
  <tr>
    ...
    <select name='vorzugs' id='vorzugs' onFocus="document.getElementById('vorg').style.display='block'" onBlur="document.getElementById('vorg').style.display='none'" tabindex="15">
      ...
      <option <?php if( $pre==2) echo"selected" ?>>Fixe</option>
  ...
  <tr>
    ...
    <td><div style="position:relative;"><div id="student" style="position:absolute; top:-30px; left:0px; width:300px; color:#fff; display:none;">Indiquez ici le salaire horaire <br />désiré. Nous suggérons 15.-/<br />heure pour du travail non qualifié<br />(pas de formation particulière).</div></div></td>
  </tr>
  <tr>
    ...
    <td><div style="position:relative;"><div id="bemerkung1" onKeyDown="" style="position:absolute; top:-30px; left:0px; width:300px; color:#fff; display:none;">Ces remarques données  <br />apparaîtrons dans la liste. <br />Idéal pour des restrictions ou<br />pour des qualifications ou services supplémentaires.</div></div></td>
  </tr>
  <tr>
    <td><input type="hidden" name="order" id="order" size="26" value="<?php echo"$order";?>">

</td>
    <td colspan="4"><input  tabindex="20" type="submit" name="nextbtn" id="nextbtn" value="Valider et la suite selon vos dispositions (2 sur 6)"  /></td>
  </tr>
</table>
 </form>
<?php
...
if (empty ($_POST['Vorname']))
{
	//echo"if (formachka['Vorname'].value == '') {";
		...
		echo"alert('Veuillez préciser votre prénom.');";
...
echo"formachka['Vorname'].focus();";
		echo"alert('Veuillez ne pas utiliser de caractères spéciaux pour le prénom.');";
$err = 1;
                                         echo"break  Out;";
...
//end
	...
	echo"if (formachka['Geb-datum'].value == '') {";
		...
		echo"alert('Veuillez nous donner une date de naissance (ex: 31.12.1970) ');";
$err = 1;
echo"break  Out;";		
//echo"return false;";
	echo"}";
...
$toc = 0;
echo"formachka['Geb-datum'].focus();";
		echo"alert('La date donnée est incorrecte ( ex: 31.1.1989) ');";
$err = 1;
echo"break  Out;";
}
...
echo"break  Out;";
	...
	echo"if (formachka['strasse'].value == '') {";
		...
		echo"alert('Veuillez nous donner le nom de la rue.');";
$err = 1;
echo"break  Out;";		
//echo"return false;";
	echo"}";
	...
	echo"if (formachka['Nr'].value == '') {";
		...
		echo"alert('Veuillez nous donner le numéro de rue.');";
$err = 1;
echo"break  Out;";		
//echo"return false;";
	echo"}";
	...
	echo"if (formachka['plz'].value == '') {";
		...
		echo"alert('Veuillez nous donner le code postal.');";
$err = 1;
echo"break  Out;";		
//echo"return false;";
	echo"}";
	...
	echo"if (formachka['ort'].value == '') {";
		...
		echo"alert('Veuillez nous donner votre lieu de résidence.');";
$err = 1;
echo"break  Out;";		
//echo"return false;";
	echo"}";
...
{
echo"formachka['strasse'].focus();";
		echo"alert('Veuillez donner une adresse correcte.');";
$err = 1;
echo"break  Out;";		
...
if (empty ($benutzername))
{
	//echo"if (formachka['benutzername'].value == '') {";
		...
		echo"alert('Veuillez choisir un identifiant.');";
$err = 1;
                                         echo"break  Out;";
		//echo"return false;";
	//echo"}";
...
{
echo"formachka['benutzername'].focus();";
		echo"alert('L\'identifiant existe déjà, veuillez en choisir un autre.');";
$err = 1;
echo"break  Out;";		
}
...
if(!isset($_FILES['image_file']))
{
echo"alert('Image non trouvée. S'il vous plait essayez de nouveau, ou choisissez ou autre image.');"; 
...
if (!($_FILES['image_file']['type'] =="image/jpeg" OR $_FILES['image_file']['type'] =="image/gif" OR $_FILES['image_file']['type'] =="image/pjpeg"))
{
echo"alert('Charger une image avec une extension jpg ou gif - Elles sont supportées par Manimano.');"; 
	echo"formachka['d1'].focus();";
echo"break  Out;"; 
}
