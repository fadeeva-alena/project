...
if($_POST["nextbtn"] == "Sauver et continuer à remplir votre profil (3 sur 6)" )
{
...
$intYear = $arrDate[2];
 if (strlen($intYear) < 4)
$errors .= "Attention au format de date (ex: 31.12.1970) / utilisez dd.mm.yyyy";
...
<input type=button value="Infos légales" onclick=location.href="Rechtliches.php" id="helpbtn3">
	...
	<input type=button value="Mes données" onclick=location.href="settings1.php?al=''" id="maindatbtn">
<?php
...
?>
  ...
  <div class="mainContent">
	<div class="content">
		<span id="title">2) Disponibilités:  <img src="images/page2.png" border="0"  usemap="#green" align="right" /></span>
<map name="green">
...
<input type="hidden" Name="Nv"  id="Nv" value="<?php echo"$Nv";?>">
	  <table width="800" border="0" cellspacing="0" cellpadding="0">
	    <tr>
	      <td width="435"><label id="smal">Planning actif:
	          <input name="zitplan" type="text" id="zitplan" value='<?php  $da1 =strtotime(date("d.m.Y")) ;
...
echo"Planning temporaire";
else
echo"Planning principal"; ?>' />

	      </label>
            <div id="TabbedPanels1" class="TabbedPanels">
              <ul class="TabbedPanelsTabGroup">
                <li class="TabbedPanelsTab" tabindex="0">Planning principal</li>
                <li class="TabbedPanelsTab" tabindex="0">Planning temporaire</li>
              </ul>
                ...
                <div class="TabbedPanelsContent">
                  ...
                  <table border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      ...
                      <td style="background:#56769d; color:#fff;"><input type='checkbox' name='Mo' onclick=javascript:Change("Mo")>Lu</td>

<td style="background:#56769d; color:#fff;"><input type='checkbox' name='Di' onclick=javascript:Change("Di")>Ma</td>
<td style="background:#56769d; color:#fff;"><input type='checkbox' name='Mi' onclick=javascript:Change("Mi")>Me</td>
<td style="background:#56769d; color:#fff;"><input type='checkbox' name='Do' onclick=javascript:Change("Do")>Je</td>
<td style="background:#56769d; color:#fff;"><input type='checkbox' name='Fr' onclick=javascript:Change("Fr")>Ve</td>
<td style="background:#56769d; color:#fff;"><input type='checkbox' name='Sa' onclick=javascript:Change("Sa")>Sa</td>
<td style="background:#56769d; color:#fff;"><input type='checkbox' name='So'onclick=javascript:Change("So")>Di</td>
...
?>
                ...
                <div class="TabbedPanelsContent">
                  ...
                  <table border="0" cellpadding="0" cellspacing="0">
                    <tr>
                       <td style="background:#56769d; color:#fff;"></td>
                      <td style="background:#56769d; color:#fff;"><input type='checkbox' name='tMo' onclick=javascript:Change("tMo")>Lu</td>

<td style="background:#56769d; color:#fff;"><input type='checkbox' name='tDi' onclick=javascript:Change("tDi")>Ma</td>
<td style="background:#56769d; color:#fff;"><input type='checkbox' name='tMi' onclick=javascript:Change("tMi")>Me</td>
<td style="background:#56769d; color:#fff;"><input type='checkbox' name='tDo' onclick=javascript:Change("tDo")>Je</td>
<td style="background:#56769d; color:#fff;"><input type='checkbox' name='tFr' onclick=javascript:Change("tFr")>Ve</td>
<td style="background:#56769d; color:#fff;"><input type='checkbox' name='tSa' onclick=javascript:Change("tSa")>Sa</td>
<td style="background:#56769d; color:#fff;"><input type='checkbox' name='tSo' onclick=javascript:Change("tSo")>Di</td>
...
?>
          ...
          Vous devez donner votre profil horaire - Certains se lèvent tôt - et ne veulent pas être dérangés le soir. Pour d'autres c'est le contraire. Et pour certains le Dimanche est sacré.<br />
          Ici vous pouvez préciser quand vous voulez être joint.
          <br /><br />
          Le planning temporaire est activé quand par exemple vous partez en vacances. Nous avons un deuxième planning de prêt pour ne pas replanifier au premier changement.
	  <br /><br />
          Le planning temporaire est limité dans le temps. Le planning principal est activé automatiquement une fois la date dépassée. <br />
          Il est obligatoire de remplir le planning principal.<br />
 	Si vous sélectionnez la case en début de ligne ou de colonne vous pourrez selectionner toute la ligne/colonne. C'est plus rapide.
          </div>
        </td>
        </tr>
      </table>

<!--      <p><input type="submit" name="nextbtn" id="nextbtn" value="Speichern und weiter zum Angebotsprofil (3 von 6)" onclick=location.href="settings3.php" /></p>
--> 
 <p><input type="submit" name="nextbtn" id="nextbtn" value="Sauver et continuer à remplir votre profil (3 sur 6)" onclick=location.href="settings3.php" /></p>
</form>
	</div>
  </div>
</div>
