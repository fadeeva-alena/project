...
//echo "</script>" ;
echo '<script language="javascript">confirm("Il n\'y a pas de résultat à votre recherche. Le cas échéant pour un meilleur résultat vous pouvez faire une recherche plus ouverte ou proche.")</script>';
?>
...
<input type=button value="Infos légales" onclick=location.href="Rechtliches.php" id="helpbtn3">
	...
	<input type=button value="Chercher" onclick=location.href="search.php?kinder=<?php echo"$cat";?>&type=<?php echo"$type";?>&gender=<?php echo"$gender";?>" id="maindatbtn">
	<input type=button value="Aide" onclick=location.href="help.php" id="helpbtn2">
  </div>
  <div class="mainContent">
	<div class="content">
	
<span id="title">Résultats</span>
<div>
<Table >
<tr>
<?PHP
