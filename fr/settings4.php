...
if($_POST["nextbtn"] == "Sauver et continuer à remplir votre profil (5 sur 6)"  )
{
$Nv=$_POST['Nv'];
...
<title>ManiMano - Einstellungen 4 von 6</title>
...
<input type=button value="Infos légales" onclick=location.href="Rechtliches.php" id="helpbtn3">
	...
	<input type=button value="Mes données" onclick=location.href="settings3.php" id="maindatbtn">
	<?php
...
</map>		<span id="title">4) Vos besoins: <img src="../images/page4.png" usemap="#green"  border="0" align="right" /> </span>
  <form method="post"  name="form1" action="settings4.php">
		<p id="maintext">Nous arrivons presque à la fin: la description de vos besoins. Elle est également optionnelle. Décrivez ici quels sont les services dont vous avez besoin. Il y a 12 types de services à la carte (les mêmes que précédemment). Donnez vous un peu de temps -  Une fois fait vous pouvez les modifier à tout moment. De même: Bleu=actif, Rouge=inactif.</p>
	  <p>&nbsp;</p>
	...
	<input type="hidden" Name="hummer"  id="hummer" value="<?php echo"$hummer ";?>">	
		    ...
		    <td width="200">
			<div id="lbltext3">Aide ménagère<br />(laver, repasser,<br /> cuisine)</div>
          ...
          <input type="hidden" Name="haushalt"  id="haushalt" value="<?php echo"$haushalt ";?>">	
		    ...
		    <td width="200">
			<div id="lbltext2">Aide scolaire und <br />Cours de musique</div>
...
$count=mysql_num_rows($result);
if($count==1){  
		        echo"<option selected>Lang: Norvegien</option>";
              }else
                     {
                     echo"<option>Lang: Norvegien</option>";
                    }			       
...
$count=mysql_num_rows($result);
if($count==1){  
		        echo"<option selected>Lang: Japonais</option>";
              }else
                     {
                     echo"<option>Lang: Japonais</option>";
                    }	
...
<input type="hidden" Name="dog"  id="dog" value="<?php echo"$dog ";?>">	
		    ...
		    <td width="200">
			<div id="lbltext2">Gardiennage<br/> de vacances</div>
...
<input type="hidden" Name="Nv"  id="Nv" value="<?php echo"$Nv";?>">
      <p><input type="submit" name="nextbtn" id="nextbtn1" value="Sauver et continuer à remplir votre profil (5 sur 6)" onclick=location.href="settings5.php" /></p>
</form>
    </div>
  </div>
</div>
