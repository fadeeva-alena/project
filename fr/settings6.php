...
$subject = "Bienvenue chez ManiMano!";
$content = "Bienvenue chez ManiMano!\n"
...
<input type=button value="Infos légales" onclick=location.href="Rechtliches.php" id="helpbtn3">
	...
	<input type="button" value="Mes données"  onclick=location.href="Settings5.php" id="maindatbtn">
<?php
...
?>
  ...
  <div class="mainContent">
	<div class="content">
		<span id="title">6) Les aspects légaux:  <img src="images/page6.png" border="0"  usemap="#green" align="right" /> </span>
<map name="green">
...
<p>
		...
		<span class="Apple-style-span" style="font-family: Calibri; font-size: 19px; line-height: 25px; font-weight:700"></span></span></p>
...
<span id="title">Caisse de retraite (BVG)</span>
	...
	<!--<p><input type="button" name="nextbtn" id="nextbtn" value="Weiter zum Angebotsprofil (3 von 5)" onclick=location.href="settings3.html" /></p>-->
	  ...
	  <p></p>
<div Align="Center"><a href="http://www.manimano.ch/Agreement.html" target="_blank">Imprimer</a> </div><br>
<div Align="Center">
<?php
                   if ($row['Agree'] == 1){                        
echo"<input type='checkbox' name='flagm1' value='flag' checked   Disabled>lu, compris et accepté, {$row['zip']} {$row['location']} {$row['firstname']} {$row['lastname']}";
}else{
echo"<input type='checkbox' name='flagm1' value='flag' onclick='javascript:Change( )();  ' >lu, compris et accepté, {$row['zip']} {$row['location']} {$row['firstname']} {$row['lastname']}";
...
echo "   $todayis   ";
echo "<br>";
echo"Vos données vont maintenant être transmises. Vous allez recevoir un mail avec lien sur lequel il faut cliquer pour finaliser votre inscription et débuter. Nous vous souhaitons beaucoup de plaisir avec ManiMano!";
}
...
<?php
                   if ($row['Agree'] == 1){      
      echo"<input name='Speichern' type='submit' id='finishbtn' value='Sauver' >";
}else
{
echo"<input name='Speichern' type='submit' id='finishbtn' value='Sauver' Disabled >";
}
?>
</form>
<script type="text/javascript">
