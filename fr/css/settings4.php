...
?>
  ...
  <div class="mainContent">
	<div class="content">
		<span id="title">4) Bedurfnisprofil: </span>
		<p id="maintext">Das Bedurfnisprofil ist das zweitletzte, was wir von lhnen wollen. Auch dieses ist optional. Hinterlegen Sie hier, was fur Dienstleistungen Sie benotigen. Auch hier gibt es 12 Dienstleistungsarten (die gleichen wie oben). Nehmen Sie sich einen Moment Zeit - auch das mussen Sie nur einmal tun - konnen es aber jederzeit andern.</p>
	  <p>&nbsp;</p>
...
?>
      ...
      <p><input type="button" name="nextbtn" id="nextbtn" value="Weiter zu lhren personlichen Eigenschaften (5 von 5)" onclick=location.href="settings5.php" /></p>
    </div>
  </div>
</div>
</body>
