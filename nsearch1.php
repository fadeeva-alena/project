...
$sql="SELECT * FROM _taccess Where Location='$loc'  ";
  $result=mysql_query($sql);   
...
$address = str_replace( " ", "+","http://maps.googleapis.com/maps/api/geocode/xml?sensor=false&address={$row[Zip]}+{$row[Location]}");
//echo"$address";
...
//list($hlong, $hlat, $altitude) = explode(",", $xml->Response->Placemark->Point->coordinates);
...
$altitude = $xml->result->geometry->location->lng;
//echo $hlat ;
//echo $hlong;
...
$sql="SELECT * FROM _taccess Where Zip='$zarea'  ";
  $result=mysql_query($sql);   


$row=mysql_fetch_array($result);

$locarea = $row[Location];
...
$map->addMarkerByCoords($hlong,$hlat,"$loc","$loc");
...
$sql="SELECT DISTINCT people_id,prof_provider,institution,street,house_nr,zip,location,latitude,longitude,image_path,firstname,lastname  FROM t_people   Where prof_provider = '1'   And   t_people.locationarea ='$locarea' And $q   ";


}else
if ($subcat == 54)
$sql="SELECT DISTINCT t_people.people_id,t_people.institution,t_people.prof_provider,t_people.street,t_people.house_nr,t_people.zip,t_people.location,t_people.latitude,t_people.longitude,t_people.image_path,t_people.firstname,t_people.lastname FROM t_people LEFT JOIN t_skills ON t_skills.people_id = t_people.people_id WHERE prof_provider = '1' And skill_type_id ='$cat'  And   t_people.locationarea ='$locarea' ";
else

$sql="SELECT * FROM t_people LEFT JOIN t_skills ON t_skills.people_id = t_people.people_id WHERE prof_provider = '1' And skill_type_id ='$cat' And skill_subtype_id ='$subcat'   And   t_people.locationarea ='$locarea' ";
  $result=mysql_query($sql);   
...
if ($ils == 1 )
{
 	...
 	$latest_array2[$count]=array( $row['institution'] ,$row['street'],$row['house_nr'], $row['zip'], $row['location'], $map->geoGetDistance($row['latitude'],$row['longitude'],$hlat,$hlong),$row['longitude'],$row['latitude'],$row['image_path'],$row['people_id'],$row['firstname'],$row['lastname'] );
...
if ($i<26)
{
$m0 = mask($latest_array2[$i][0]);
$m1 = mask($latest_array2[$i][10]);
$m2 = mask($latest_array2[$i][11]);
$m3 = mask($Address[$i]);
$map->addMarkerIcon('/images/Markers/blue_Marker'.$Arr[$i].'.png','/images/Markers/blue_Marker'.$Arr[$i].'.png',0,0,10,10);
$map->addMarkerByCoords($latest_array2[$i][6],$latest_array2[$i][7],$latest_array2[$i][0],"<b> $m0<br>$m1 $m2<br>$m3</b>");
}			
...
if ($cat == 14)
{
$sql="SELECT DISTINCT people_id,institution,gender,street,house_nr,zip,location,latitude,longitude,image_path,firstname,lastname  FROM t_people Where   prof_provider = '0' And gender ='1'  And   t_people.locationarea ='$locarea' And $q   ";

}else
if ($subcat == 54)

$sql="SELECT DISTINCT t_people.people_id,t_people.institution,t_people.gender,t_people.street,t_people.house_nr,t_people.zip,t_people.location,t_people.latitude,t_people.longitude,t_people.image_path,t_people.firstname,t_people.lastname FROM t_people LEFT JOIN t_skills ON t_skills.people_id = t_people.people_id WHERE prof_provider = '0' And gender ='1' And skill_type_id ='$cat' And  t_people.locationarea ='$locarea'";
else

$sql="SELECT * FROM t_people LEFT JOIN t_skills ON t_skills.people_id = t_people.people_id WHERE prof_provider = '0' And gender ='1' And skill_type_id ='$cat' And skill_subtype_id ='$subcat' And  t_people.locationarea ='$locarea'";
...
if ($cat == 14)
{
$sql="SELECT DISTINCT people_id,institution,gender,street,house_nr,zip,location,latitude,longitude,image_path,firstname,lastname  FROM t_people  Where  prof_provider = '0' And gender ='2'   And   t_people.locationarea ='$locarea'  And $q ";

}else
if ($subcat == 54)
$sql="SELECT DISTINCT t_people.people_id,t_people.institution,t_people.street,t_people.gender,t_people.house_nr,t_people.zip,t_people.location,t_people.latitude,t_people.longitude,t_people.image_path,t_people.firstname,t_people.lastname FROM t_people LEFT JOIN t_skills ON t_skills.people_id = t_people.people_id WHERE prof_provider = '0' And gender ='2' And skill_type_id ='$cat'  And  t_people.locationarea ='$locarea'";
else
$sql="SELECT * FROM t_people LEFT JOIN t_skills ON t_skills.people_id = t_people.people_id WHERE prof_provider = '0' And gender ='2' And skill_type_id ='$cat' And skill_subtype_id ='$subcat'  And  t_people.locationarea ='$locarea'";
} 
if ($gender=='2'){
$todayis = date("Y-m-d H:i:s") ;
...
if ($cat == 14)
{
$sql="SELECT DISTINCT people_id,institution,gender,street,house_nr,zip,location,latitude,longitude,image_path,firstname,lastname  FROM t_people  Where  prof_provider = '0'   And   t_people.locationarea ='$locarea' And $q  ";

}else
if ($subcat == 54)
$sql="SELECT DISTINCT t_people.people_id,t_people.institution,t_people.gender,t_people.street,t_people.house_nr,t_people.zip,t_people.location,t_people.latitude,t_people.longitude,t_people.image_path,t_people.firstname,t_people.lastname FROM t_people LEFT JOIN t_skills ON t_skills.people_id = t_people.people_id WHERE prof_provider = '0' And skill_type_id ='$cat'  And  t_people.locationarea ='$locarea'";
else
$sql="SELECT * FROM t_people LEFT JOIN t_skills ON t_skills.people_id = t_people.people_id WHERE prof_provider = '0'  And skill_type_id ='$cat' And skill_subtype_id ='$subcat' And t_people.locationarea='$locarea'";
}   
$result=mysql_query($sql); 
$count = 0;
while ($row=mysql_fetch_array($result)) {
...
$latest_array[$count]=array($row['firstname'],$row['lastname'],$row['street'],$row['house_nr'], $row['zip'], $row['location'],$map->geoGetDistance($row['latitude'],$row['longitude'],$hlat,$hlong),$row['longitude'],$row['latitude'],$row['image_path'],$row['people_id'],$row['institution']);
...
if ($j<26)
{
$m0 = mask($latest_array[$i][0]);
$m1 = mask($latest_array[$i][1]);
$m2 = mask($latest_array[$i][11]);
$m3 = mask($Address[$i]);
$map->addMarkerIcon('/images/Markers/red_Marker'.$Arr[$j].'.png','/images/Markers/red_Marker'.$Arr[$i].'.png',0,0,10,10);
$map->addMarkerByCoords($latest_array[$i][7],$latest_array[$i][8],$latest_array[$i][0],"<b>$m0 $m1<br> $m2<br>$m3</b>");
}			
...
if ($subcat == 54)
$sql="SELECT DISTINCT t_people.people_id,t_people.institution,t_people.prof_provider,t_people.street,t_people.house_nr,t_people.zip,t_people.location,t_people.latitude,t_people.longitude,t_people.image_path,t_people.firstname,t_people.lastname FROM t_people LEFT JOIN t_needs ON t_needs.people_id = t_people.people_id WHERE prof_provider = '1' And need_type_id ='$cat'  And   t_people.locationarea ='$locarea'";
else

$sql="SELECT * FROM t_people LEFT JOIN t_needs ON t_needs.people_id = t_people.people_id WHERE prof_provider = '1' And need_type_id ='$cat' And need_subtype_id ='$subcat' And  t_people.locationarea ='$locarea'";
  $result=mysql_query($sql);   
...
if ($subcat == 54)
$sql="SELECT DISTINCT t_people.people_id,t_people.institution,t_people.gender,t_people.street,t_people.house_nr,t_people.zip,t_people.location,t_people.latitude,t_people.longitude,t_people.image_path,t_people.firstname,t_people.lastname FROM t_people LEFT JOIN t_needs ON t_needs.people_id = t_people.people_id WHERE prof_provider = '0' And gender ='1' And need_type_id ='$cat'  And  t_people.locationarea ='$locarea'";
else

$sql="SELECT * FROM t_people LEFT JOIN t_needs ON t_needs.people_id = t_people.people_id WHERE prof_provider = '0' And gender ='1' And need_type_id ='$cat' And need_subtype_id ='$subcat' And  t_people.locationarea ='$locarea'";
}  
if ($gender=='1'){
$todayis = date("Y-m-d H:i:s") ;
...
if ($subcat == 54)
$sql="SELECT DISTINCT t_people.people_id,t_people.institution,t_people.gender,t_people.street,t_people.house_nr,t_people.zip,t_people.location,t_people.latitude,t_people.longitude,t_people.image_path,t_people.firstname,t_people.lastname FROM t_people LEFT JOIN t_needs ON t_needs.people_id = t_people.people_id WHERE prof_provider = '0' And gender ='2' And need_type_id ='$cat'  And  t_people.locationarea ='$locarea'";
else
$sql="SELECT * FROM t_people LEFT JOIN t_needs ON t_needs.people_id = t_people.people_id WHERE prof_provider = '0' And gender ='2' And need_type_id ='$cat' And need_subtype_id ='$subcat' And  t_people.locationarea ='$locarea'";
} 
if ($gender=='2'){
$todayis = date("Y-m-d H:i:s") ;
...
if ($cat == 14)
{
$sql="SELECT DISTINCT people_id,gender,institution,street,house_nr,zip,location,latitude,longitude,image_path,firstname,lastname  FROM t_people   Where   prof_provider = '0' And   t_people.locationarea ='$locarea'  And $q ";

}else
if ($subcat == 54)
$sql="SELECT DISTINCT t_people.people_id,t_people.institution,t_people.gender,t_people.street,t_people.house_nr,t_people.zip,t_people.location,t_people.latitude,t_people.longitude,t_people.image_path,t_people.firstname,t_people.lastname FROM t_people LEFT JOIN t_needs ON t_needs.people_id = t_people.people_id WHERE prof_provider = '0'  And need_type_id ='$cat'  And  t_people.locationarea ='$locarea'";
else

$sql="SELECT * FROM t_people LEFT JOIN t_needs ON t_needs.people_id = t_people.people_id WHERE prof_provider = '0'  And need_type_id ='$cat' And need_subtype_id ='$subcat'  And  t_people.locationarea='$locarea'";
}   
$result=mysql_query($sql);  
$count = 0 ;
while ($row=mysql_fetch_array($result)) {
                ...
                <div class="navbar-collapse collapse" id="navbar-collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="active nav-item">
                          ...
                          <a href="nsearch.php?kinder=<?php echo"$cat";?>&type=<?php echo"$type";?>&gender=<?php echo"$gender";?>&ke=<?php echo"$ke1";?>">Suche</a>
                        </li>
                        <li class="nav-item">
...
if($i<26)
{
$src = 'images/profile/{$latest_array2[$i][8]}';
  
$objImage = new ImageManipulation($src);
if ( $objImage->imageok ) {
    $objImage->setPixelate(10);

$objImage->save('images/profile/temp/{$latest_array2[$i][8]}');
}
}
}
...
//echo">";
$m= $prov+$in-1 ; 
echo"<tr id=$j bgcolor='".($i == 0 ? 'lightblue' : 'white')."' onclick=loadTwo('nDetail1.php?id={$latest_array2[$i][9]}&icon=blue_Marker$Arr[$i]',$i,$m)>";
echo"<td>";
...
echo "  $m0 <br>$m1 $m2 <br>";
 $sidebar = $map->getSidebar();
//echo"$sidebar" ;
$m3=mask($latest_array2[$i][1]);
$m4=mask($latest_array2[$i][2]);
$m5=mask($latest_array2[$i][3]);
$m6=mask($latest_array2[$i][4]);
echo "$m3 $m4 <br> $m5 $m6 ";
echo"</td>";
echo"<td>";
$pi=ltrim($latest_array2[$i][8]);
$pi=rtrim($pi);
$src = 'images/profile/'.$pi;
//$src = 'images/profile/'.'butterfly.jpg ';

//echo"$src <br>"; 
$objImage = new ImageManipulation($src);
if ( $objImage->imageok ) {
    $objImage->setPixelate(3);
$dest='images/profile/temp/'.$pi;

$objImage->save($dest);
}

echo "<img src=";
echo "'images/profile/temp/{$latest_array2[$i][8]}'";
...
if($j<26)
{
echo"<tr id=$j bgcolor='".($i == 0 ? 'lightblue' : 'white')."'  onclick=loadTwo('nDetail1.php?id={$latest_array[$i][10]}&icon=red_Marker$Arr[$j]',$j,$m)>";
echo"<td>";
echo "<img src=";
...
$m0=mask($latest_array[$i][0]);
$m1=mask($latest_array[$i][1]);
$m2=mask($latest_array[$i][2]);
$m3=mask($latest_array[$i][3]);
$m4=mask($latest_array[$i][4]);
$m5=mask($latest_array[$i][5]);

echo "$m0 $m1 <br>";
echo "$m2 $m3<br>  $m4 $m5 ";
	echo"</td>";
echo"<td>";
$pi=ltrim($latest_array[$i][9]);
$pi=rtrim($pi);
$src = 'images/profile/'.$pi;
//$src = 'images/profile/'.'butterfly.jpg ';
...
echo "<img src=";
echo "'images/profile/temp/{$latest_array[$i][9]}'";
...
echo "<div style='margin-right:9px;'>";
$map->printMap(); 
echo "</div>";
...
echo"<iframe BGCOLOR='#6593cf' Name='frame1' scrolling='no'  src='nDetail1.php?id={$latest_array2[0][9]}&icon=blue_Marker$Arr[0]'  height=350 width=850  frameborder='0' </iframe> ";
//echo"</div>";
}else
{
if ($in > 0 )
{
//echo "<div class='content'>";
echo"<iframe BGCOLOR='#6593cf' Name='frame1'  scrolling='no' src='nDetail1.php?id={$latest_array[0][10]}&icon=red_Marker$Arr[0]'  height=350  width=850 frameborder='0' </iframe> ";
//echo"</div>";
}
}
