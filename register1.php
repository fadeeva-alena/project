...
function showPos(event, text, m, pointShift) {
    ...
    if(pointShift !== undefined && pointShift !== null) {
        x += pointShift.x;
        y += pointShift.y;
    }
...
<DIV id='PopUp' style='display: none; position: absolute; left: 100px; top: 50px; width: 300px; color: #fff; border: solid black 1px; padding: 10px; background-color: rgb(200,100,100); text-align: justify; font-size: 12px; width: 135px;' onmouseover="document.getElementById('PopUp').style.display = 'none' ">
...
<div class="row">
  ...
  <div class="row">
    ...
    <div class="col-md-3"><input type="text" name="Geb-datum" id="Geb-datum" value="<?php echo"$Geb_datum1";?>" onFocus="showPos(event,'Ihr Geburtsdatum wird nicht veröffentlicht.<br />Wir können es aber z.B. einsetzen, um<br />sicherzustellen, dass wirklich Sie anrufen<br />(Authentifizierung).','Geb-datum')" onBlur="document.getElementById('PopUp').style.display='none'" tabindex="6"> <span class="star">*</span></div>
   
<div class=""><div style="position:relative;"><div id="date" style="position:absolute; top:-30px; left:0px; width:300px; color:#fff; display:none;">Ihr Geburtsdatum wird nicht veröffentlicht.<br />Wir können es aber z.B. einsetzen, um<br />sicherzustellen, dass wirklich Sie anrufen<br />(Authentifizierung).</div></div></div>
  </div>
  <div class="row">
...
?>
      ...
      <input name="Bild" type="image" width="<?php echo"$image_x  "; ?>" Height="<?php echo"$image_y"; ?> " id="Bild" src="<?php echo"$im"; ?>" style="float:left; margin-right:10px;" onMouseOver="showPos(event,'Wenn man Sie noch nicht kennt, fasst man viel leichter Vertrauen zu Ihnen, wenn Sie hier ein schönes Bild hinterlegen - und man erkennt Sie wieder, auch wenn man Ihren Namen nicht kennt (Pflicht).','Bild')" onMouseOut="document.getElementById('Popup').style.display='none'" >
      ...
      <div  style="text-align:center; overflow:hidden; width:72px; height:24px; border:none; background:url(images/button_bg.gif) top left no-repeat;">
         ...
         <input type="file"   name="image_file"  id="image_file" size="1" style="margin-top: -50px; margin-left:-410px; -moz-opacity: 0; filter: alpha(opacity=0); opacity: 0; font-size: 150px; height: 100px;" OnChange="javascript:document.Form1.UploadImage.click();" onMouseOver="showPos(event,'Wenn man Sie noch nicht kennt, fasst man viel leicht Vertrauen zu Ihnen, wenn Sie hier ein schönes Bild hinterlegen - und man erkennt Sie wieder, auch wenn man Ihren Namen nicht kennt (Pflicht).','image_file')" onMouseOut="document.getElementById('PopUp').style.display='none'" >
      </div>
      <div id="h" class="hidden" style="display:none;"><input type="submit" id="UploadImage" value="Upload Image" name="action" tabindex=0></div>
      </div>
      <div class="col-md-4"><div style="position:relative;"><div id="avatar" style="position:absolute; top:-30px; left:0px; width:300px; color:#fff; display:none;">Wenn man Sie noch nicht kennt, fasst man viel leicht Vertrauen zu Ihnen, wenn Sie hier ein schönes Bild hinterlegen - und man erkennt Sie wieder, auch wenn man Ihren Namen nicht kennt (Pflicht).</div></div></div>
  </div>
  <div class="row">
  ...
  <div class="row">
    ...
    <div class="col-md-4"><input type="text" name="handy" id="handy" value="<?php echo"$handy";?>" onFocus="showPos(event,'Die Angabe der Handynummer ist<br />notwendig. Falls Sie das Passwort<br />vergessen, senden wir lhnen dieses per SMS zu.','handy')" onBlur="document.getElementById('PopUp').style.display='none'" tabindex="13"> <span class="star"></span></div>
    <div class=""><div style="position:relative;"><div id="handy1" style="position:absolute; top:-25px; left:0px; width:300px; color:#fff; display:none;">Die Angabe der Handynummer ist<br />notwendig. Falls Sie das Passwort<br />vergessen, senden wir lhnen dieses per SMS zu.</div></div></div>
  </div>
  <div class="row">
  ...
  <div class="row">
    ...
    <div class="col-md-4">
    <select name='vorzugs' id='vorzugs' onFocus="showPos(event,'Hier können sie angeben, wie sie am <br />Liebsten erreicht werden können','vorzugs', {x: 170, y: 0})" onBlur="document.getElementById('PopUp').style.display='none'" tabindex="15">
      <option>Handy</option>
    ...
    <div class="col-md-4"><div style="position:relative;"><div id="vorg" style="position:absolute; top:-15px; left:0px; width:300px; color:#fff; display:none;">Hier können sie angeben, wie sie am <br />Liebsten erreicht werden können</div></div></div>
  </div>
  <div class="row">
    <div class="col-md-4">Benutzername:</div>
    <div class="col-md-3"><input type="text" name="benutzername" id="benutzername" value="<?php  echo"$username ";?>" onFocus="showPos(event,'Sie können einen Benutzernamen wählen. <br />Wir prüfen, ob er noch frei ist. <br />Wir schlagen Vorname. Nachname. Ort vor, <br />z.B. David.Schlaepfer.Egg','benutzername')" onBlur="document.getElementById('PopUp').style.display='none'" tabindex="16"></div>
    ...
    <div class=""><div style="position:relative;"><div id="pass" style="position:absolute; top:-30px; left:0px; width:300px; color:#fff; display:none;">Sie können einen Benutzernamen wählen. <br />Wir prüfen, ob er noch frei ist. <br />Wir schlagen Vorname. Nachname. Ort vor, <br />z.B. David.Schlaepfer.Egg</div></div></div>
  </div>
  <div class="row">
    <div class="col-md-4">Stundenlohn:</div>
    <div class="col-md-4"><input type="text" name="stundenlohn" id="stundenlohn" size="11" value="<?php echo"$stundenlohn ";?>" onFocus="showPos(event,'Hier können Sie lhren gewünschten <br />Stundenlohn eingeben. Wir schlagen 19.-/<br />Stunde für unqualifizierte Arbeiten vor<br />(ohne entsp. Ausbildung).','stundenlohn')" onBlur="document.getElementById('PopUp').style.display='none'" tabindex="19"> Fr.</div>
    <div class="col-md-4"><div style="position:relative;"><div id="student" style="position:absolute; top:-30px; left:0px; width:300px; color:#fff; display:none;">Hier können Sie lhren gewünschten <br />Stundenlohn eingeben. Wir schlagen 19.-/<br />Stunde für unqualifizierte Arbeiten vor<br />(ohne entsp. Ausbildung).</div></div></div>
  </div>
  <div class="row">
    <div class="col-md-4">Bemerkung:</div>
    <div class="col-md-4"><textarea  tabindex="19" name="bemerkung" cols="45" id="bemerkung" value="<?php echo "$bemerkung";?>" onFocus="showPos(event,'Die Bemerkung, welche Sie hier eingeben <br />wird bei in der Trefferliste mitangezeigt. <br />Ideal z.B. für Einschränkungen oder <br />zusätzliche Angaben / Qualifizierungen.','bemerkung')" onBlur="document.getElementById('PopUp').style.display='none'"><?php echo "$bemerkung";?></textarea></div>
    <div class="col-md-4"><div style="position:relative;"><div id="bemerkung1" onKeyDown="" style="position:absolute; top:-30px; left:0px; width:300px; color:#fff; display:none;">Die Bemerkung, welche Sie hier eingeben <br />wird bei in der Trefferliste mitangezeigt. <br />Ideal z.B. für Einschränkungen oder <br />zusätzliche Angaben / Qualifizierungen.</div></div></div>
  </div>
  <div class="row">
    <input type="hidden" name="order" id="order" size="26" value="<?php echo"$order";?>">
    <div class="col-md-4">
      <input  tabindex="20" type="submit" name="nextbtn" id="nextbtn" class="form-control btn btn-primary" value="Speichern und weiter zur zeitlichen Verfügbarkeit (2 von 6)"  />
    </div>
  </div>
</form>
<?php
