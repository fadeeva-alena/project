...
if($_POST["nextbtn"] == "Speichern und weiter zum Bedürfnisprofil (4 von 6)"  )
{
$Nv=$_POST['Nv'];
...
<div id="contentIndex"  onload="lo()">
	<h1 id="title">3) Angebotsprofil:  <img src="images/page3.png" border="0"  usemap="#green" align="right" /></h1>
	<map name="green">
		<area shape="rect" title="Persönliche Daten"  coords="10,3,26,28" href="javascript:Nav(1);">
		<area shape="rect" title="Zeitliche Verfügbarkeit" coords=coords="30,3,47,30" href="javascript:Nav(2);">
		<area shape="rect" title="Bedürfnisprofil"  coords="90,3,107,30"  href="javascript:Nav(4);">
		<area shape="rect" title="Über meine Person"  coords="113,0,129,30" href="javascript:Nav(5);">
		<area shape="rect" title="Rechtliche Aspekte" coords="135,2,149,30" href="javascript:Nav(6);">
	</map>
  	<form method="post"  name="form1" id="form3" action="settings3.php">
		<p id="maintext">Das Hinterlegen eines Angebotsprofils ist optional. Wenn Sie wollen, dass man sie findet, wenn jemand Unterstützung braucht, kommen sie natürlich nicht darum herum. Es gibt 12 Diensleistungsarten. Klicken Sie jede an, die für Sie zutrifft und Ihnen Spass macht - Blau steht für aktiviert - Rot steht für inaktiv.</p>
	  	<p>&nbsp;</p>
		<table width="900" border="0" cellspacing="10" cellpadding="0">
		  	<tr>
			    ...
			    <td width="200">
					<div id="lbltext2">Haushalt<br />(waschen, bügeln,<br /> kochen)</div>
...
?>
			...
			<input type="hidden" Name="Nv"  id="Nv" value="<?php echo"$Nv";?>">
      		<p><input type="submit" name="nextbtn" id="nextbtn" class="form-control btn btn-primary" value="Speichern und weiter zum Bedürfnisprofil (4 von 6)" onclick=location.href="settings4.php" /></p>
		</form>
    </div>
</div>
</body>
