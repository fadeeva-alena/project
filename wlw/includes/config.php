...
switch ($location) {
	case "LIVE":
		...
		define( 'DB_USER',				'wu' );
		define( 'DB_PASSWORD',			'schel77' );
		define( 'DB_NAME',				'wu_db' );			
...
// locations
	 ...
	 $fg_activitylogs = array();
	$fg_activitylogs['sortname'] 			= "activity_log_id";
	$fg_activitylogs['sortorder'] 			= "desc";
	$fg_activitylogs['rp'] 					= 20;
	$fg_activitylogs['rpOptions'] 			= $fgrid_rp_options;
	$fg_activitylogs['showTableToggleBtn'] 	= "false";
	$fg_activitylogs['width'] 				= "955";
	$fg_activitylogs['height'] 				= "536";
	$fg_activitylogs['resizable'] 			= "false";
	
	 // Provider/co=workers Management
$fg_co_workers = array();
	$fg_co_workers['sortname'] 			= "lastname";
	$fg_co_workers['sortorder'] 			= "asc";
	$fg_co_workers['rp'] 					= 20;
	$fg_co_workers['rpOptions'] 			= $fgrid_rp_options;
	$fg_co_workers['showTableToggleBtn'] 	= "false";
	$fg_co_workers['width'] 				= "955";
	$fg_co_workers['height'] 				= "536";
	$fg_co_workers['resizable'] 			= "false";

$fg_translations = array();
	$fg_translations['sortname'] 			= "fieldname";
	$fg_translations['sortorder'] 			= "asc";
	$fg_translations['rp'] 					= 20;
	$fg_translations['rpOptions'] 			= $fgrid_rp_options;
	$fg_translations['showTableToggleBtn'] 	= "false";
	$fg_translations['width'] 				= "955";
	$fg_translations['height'] 				= "536";
	$fg_translations['resizable'] 			= "false";

$fg_event_kind = array();
	$fg_event_kind['sortname'] 			= "id";
	$fg_event_kind['sortorder'] 			= "asc";
	$fg_event_kind['rp'] 					= 20;
	$fg_event_kind['rpOptions'] 			= $fgrid_rp_options;
	$fg_event_kind['showTableToggleBtn'] 	= "false";
	$fg_event_kind['width'] 				= "955";
	$fg_event_kind['height'] 				= "536";
	$fg_event_kind['resizable'] 			= "false";

$fg_event_type = array();
	$fg_event_type['sortname'] 			= "id";
	$fg_event_type['sortorder'] 			= "asc";
	$fg_event_type['rp'] 					= 20;
	$fg_event_type['rpOptions'] 			= $fgrid_rp_options;
	$fg_event_type['showTableToggleBtn'] 	= "false";
	$fg_event_type['width'] 				= "955";
	$fg_event_type['height'] 				= "536";
	$fg_event_type['resizable'] 			= "false";
