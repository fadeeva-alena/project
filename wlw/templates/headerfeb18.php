...
<td style="background:url('images/menubar.png');">
    ...
    <div id="navigation" style="width:1100;margin:0 auto;float:none;border:border:0px solid red;">
    
    
    <ul class="sf-menu" style="width:1100px;margin:0 auto;float:none;border:0px solid red;">
...
<td style="background:url('images/bodybg.png') fixed;"> 
    ...
    <div id="content" style="border:0px solid #eeeeee;padding-bottom:20px;margin:0 auto;width:952px;">
