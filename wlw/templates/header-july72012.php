...
<div style="display:none;position:absolute;z-index:100;background:url('images/overdue.png');width:100%;height:100%;text-align:center;" id="loading_img"><img src="images/loading_animation.gif" style="margin:250px auto auto;"/></div>
