...
<ul>
	...
	INSERT INTO `wu_db`.`t_field_names` (`id`, `fieldname`, `fieldname_de`, `fieldname_eng`, `fieldname_fr`, `fieldname_it`, `helptext_de`, `helptext_eng`, `helptext_fr`, `helptext_it`, `table`) VALUES ('706', 'Daten bearbeiten', 'Daten bearbeiten', 'Daten bearbeiten', 'Daten bearbeiten', 'Daten bearbeiten', 'Daten bearbeiten', 'Daten bearbeiten', 'Daten bearbeiten', 'Daten bearbeiten', '11');
	
	
     INSERT INTO `wu_db`.`t_field_names` (`id`, `fieldname`, `fieldname_de`, `fieldname_eng`, `fieldname_fr`, `fieldname_it`, `helptext_de`, `helptext_eng`, `helptext_fr`, `helptext_it`, `table`) VALUES ('646', 'Receive request', ' Es ist ein Gesuch um Übernahme von Datensätzen eingegangen', 'Daten bearbeiten', 'Daten bearbeiten', 'Daten bearbeiten', 'Daten bearbeiten', 'Daten bearbeiten', 'Daten bearbeiten', 'Daten bearbeiten', '11');
