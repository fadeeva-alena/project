...
<td style="background:url('images/menubar.png');">
    ...
    <div id="navigation" style="width:1255;margin:0 auto;float:none;border:border:0px solid red;">
    
    
    <ul class="sf-menu" style="width:1255px;margin:0 auto;float:none;border:0px solid red;">
