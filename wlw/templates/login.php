...
<div id="login-container" style="width:390px;">	
  	<div class="login-content"  style="width:390px;"> 
		...
		?>
                ...
                <div style="float:left;clear:both;padding-top:2px;"><label><?php
		...
		?></label>
                ...
                <label><?php
		$sqlfield = mysql_query("select * from t_field_names where id=199");
		$rowfield = mysql_fetch_array($sqlfield);
		if ($_SESSION[WEBSITE_ALIAS]['language'] ==1){
			echo $rowfield['fieldname_de'];
		}elseif ($_SESSION[WEBSITE_ALIAS]['language'] ==2){
		...
		?></label>
                <div><input class="text-field" id="password" name="password" type="password" maxlength="30" style="width:140px;" /> &nbsp;<input class="button" name="Login" type="submit" value="<?php
		$sqlfield = mysql_query("select * from t_field_names where id=265");
		$rowfield = mysql_fetch_array($sqlfield);
		if ($_SESSION[WEBSITE_ALIAS]['language'] ==1){
			echo $rowfield['fieldname_de'];
		}elseif ($_SESSION[WEBSITE_ALIAS]['language'] ==2){
		...
		?>" />&nbsp;</div>
                ...
                <div class="clr"></div>
                <div align="center"><a href="index.php?option=forgotpassword"><?php
