...
class String
{
	function sql_safe($var = "")
	{
		...
		$var = str_replace("รค","ไ",$var);	
		$var = str_replace("รถ","๖",$var);	
		$var = str_replace("รผ","ü",$var);	
		$var = str_replace("รฉ","้",$var);	
		$var = str_replace("ำ“","๓",$var);	
		$var = str_replace("รก","แ",$var);	
		$var = str_replace("ร","ไ",$var);	
		$var = str_replace("รจ","แ",$var);
