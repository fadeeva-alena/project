		  	...
		  	$("#login-indicator-msg").fadeTo(200,0.1,function()  { //start fading the messagebox
              	...
              	function() { 
					...
					//http://localhost/json/display-event.php?events_id=3275&titlecolor=000000&bgcolor=FFFFFF&titlebgcolor=CCCCCC&tablegrid=CCCCCC
				 	...
				 	document.location='display-event-from-provider.php?provider_id=<?php echo $_GET['provider_id'];?>&titlecolor=<?php echo $_GET['titlecolor'];?>&bgcolor=<?php echo $_GET['bgcolor'];?>&titlebgcolor=<?php echo $_GET['titlebgcolor'];?>&tablegrid=<?php echo $_GET['tablegrid'];?>';
