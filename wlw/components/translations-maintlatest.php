...
<div class="content-main wide70">
    ...
    <form action="<?php echo INDEX_PAGE . $page_option; ?>" method="post" id="frm_<?php echo $page_name; ?>" enctype="multipart/form-data">
		...
		<?php echo $req_fld?></label></td>
                    <?php if ( $is_editable_field ) { ?>
                    <td>
                    	<input type="text" name="fieldname_de" id="fieldname_de" style="width:190px;" maxlength="50" value="<?php echo fixEncoding($fieldname_de)?>" />
					</td>
                    <?php } else { ?>
		...
		?><?php echo $req_fld?> 
                    ...
                    <?php if ( $is_editable_field ) { ?>
                    <td>
                    	<input type="text" name="fieldname_eng" id="fieldname_eng" style="width:190px;" maxlength="50" value="<?php echo fixEncoding($fieldname_eng)?>" />
					</td>
                    <?php } else { ?>
		...
		?><?php echo $req_fld?> 
                    ...
                    <?php if ( $is_editable_field ) { ?>
                    <td>
                    	<input type="text" name="fieldname_fr" id="fieldname_fr" style="width:190px;" maxlength="50" value="<?php echo fixEncoding($fieldname_fr)?>" />
					</td>
                    <?php } else { ?>
		...
		?><?php echo $req_fld?> 
                    ...
                    <?php if ( $is_editable_field ) { ?>
                    <td>
                    	<input type="text" name="fieldname_it" id="fieldname_it" style="width:190px;" maxlength="50" value="<?php echo fixEncoding($fieldname_it)?>" />
					</td>
                    <?php } else { ?>
