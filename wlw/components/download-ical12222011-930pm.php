...
if ($_GET['date_id'] != ""){
	...
	//$icaldetails .="DTEND;TZID=Europe/Zurich:".date('Ymd',strtotime($rowquery['events_end_date']))."T".date('His',strtotime($rowquery['time_end']))."Z\n";
	$icaldetails .="DTEND;TZID=".date_default_timezone_set('UTC').":"  . date('Ymd',strtotime($rowquery['events_end_date']))."T".date('His',strtotime($rowquery['time_end']))."Z\n";
	}else{
	//$icaldetails .="DTEND;TZID=Europe/Zurich:".date('Ymd',strtotime($rowquery['events_end_date']))."T180000Z\n";
	$icaldetails .="DTEND;TZID=".date_default_timezone_set('UTC').":"  . date('Ymd',strtotime($rowquery['events_end_date']))."T180000Z\n";
	}
	
	
	if ($rowquery['time_start'] != "00:00:00"){
	//$icaldetails .="DTSTART;TZID=Europe/Zurich:".date('Ymd',strtotime($rowquery['events_start_date']))."T".date('His',strtotime($rowquery['time_start']))."Z\n";
	
	$icaldetails .="DTSTART;TZID=".date_default_timezone_set('UTC').":" .  date('Ymd',strtotime($rowquery['events_start_date']))."T".date('His',strtotime($rowquery['time_start']))."Z\n";
	
	}else{
	//$icaldetails .="DTSTART;TZID=Europe/Zurich:".date('Ymd',strtotime($rowquery['events_start_date']))."T180000Z\n";
	$icaldetails .="DTSTART;TZID=".date_default_timezone_set('UTC').":" .  date('Ymd',strtotime($rowquery['events_start_date']))."T180000Z\n";
	}
	$icaldetails .="DTSTAMP;TZID=Europe/Zurich:".date('Ymd',strtotime($rowquery['etimestamp']))."T".date('His',strtotime($rowquery['etimestamp']))."Z\n";
	$icaldetails .="LAST-MODIFIED;TZID=Europe/Zurich:".date('Ymd',strtotime($rowquery['elast_change']))."T".date('His',strtotime($rowquery['elast_change']))."Z\n";
