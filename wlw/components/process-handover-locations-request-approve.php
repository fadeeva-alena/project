...
mysql_query("update t_event set provider='$provider_id' where id='$locationsid'");
		mysql_query("update t_handover_locations set request_status='approved' where id='$id'");
...
$headers = "";
		...
		$providerid = $rowadmin['id'];
			...
			$sqlfield = mysql_query("select * from t_field_names where id=638");
			$rowfield = mysql_fetch_array($sqlfield);
			if ($_SESSION[WEBSITE_ALIAS]['language'] ==1){
