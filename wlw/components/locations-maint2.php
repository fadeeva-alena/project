                    ...
                    <td>
						...
						$(document).ready(function() {
							$('#loc_name').focus(function () {
								$('#textloc_name').show();
								$('#textloc_name').html('<?php echo fixEncoding($helptext);?>');
							});
                    ...
                    <td>
						...
						$(document).ready(function() {
							$('#loc_detail').focus(function () {
								$('#textloc_detail').show();
								$('#textloc_detail').html('<?php echo fixEncoding($helptext);?>');
							});
                    ...
                    <td>
						...
						$(document).ready(function() {
							$('#loc_adress1').focus(function () {
								...
								$('#textloc_adress1').html('<?php echo fixEncoding($helptext);?>');
							});
                    ...
                    <td>
						...
						$(document).ready(function() {
							$('#loc_adress2').focus(function () {
								...
								$('#textloc_adress2').html('<?php echo fixEncoding($helptext);?>');
							});
				...
				<script>
						$(document).ready(function() {
							$('#loc_country').focus(function () {
								...
								$('#textloc_country').html('<?php echo fixEncoding($helptext);?>');
							});
...
$().ready(function() {
	...
	var loc_zipsuggest = [
		<?php
		$countloc_loc = 0;
		$query = mysql_query("SELECT * from t_zipch
				  order by ZIP asc");
	...
	$("#loc_zip").result(function(event, row, formatted) {
		...
		$('#clone_location').html(row.loc_loc);
		//$('#locid').val(row.locid);
		var r = $('#clone_location');
		
		r.text(r.html());
		r.html(r.text());
		$('#loc_loc').val($('#clone_location').html());	
...
.ac_over {
	...
	color: white;
				...
				<input type="text" id="loc_zip" name="loc_zip" style="width:190px;" maxlength="150" value=""/>
		...
		<script>
						$(document).ready(function() {
							$('#loc_zip').focus(function () {
								$('#textloc_zip').show();
								$('#textloc_zip').html('<?php echo fixEncoding($helptext);?>');
							});
							$('#loc_zip').blur(function () {
								$('#textloc_zip').hide();
								$('#textloc_zip').html('');
		...
		?><?php echo $req_fld?></label></td>
                    <?php if ( $is_editable_field ) { ?>
                    <td>
                    	<input type="text"  autocomplete="off" name="loc_loc" id="loc_loc" style="width:190px;" maxlength="150" value="" />
						<script>
						$(document).ready(function() {
							$('#loc_loc').focus(function () {
								$('#textloc_loc').show();
								$('#textloc_loc').html('<?php echo fixEncoding($helptext);?>');
							});
							$('#loc_loc').blur(function () {
								$('#textloc_loc').hide();
								$('#textloc_loc').html('');
                    ...
                    <td>
						...
						$(document).ready(function() {
							$('#loc_shortdesc').focus(function () {
								...
								$('#textloc_shortdesc').html('<?php echo fixEncoding($helptext);?>');
							});
		...
		<script>
						$(document).ready(function() {
							$('#loc_contact_gender').focus(function () {
								...
								$('#textloc_contact_gender').html('<?php echo fixEncoding($helptext);?>');
							});
                    ...
                    <td>
						...
						$(document).ready(function() {
							$('#loc_contact_name').focus(function () {
								...
								$('#textloc_contact_name').html('<?php echo fixEncoding($helptext);?>');
							});
                    ...
                    <td>
						...
						$(document).ready(function() {
							$('#loc_contact_phone').focus(function () {
								...
								$('#textloc_contact_phone').html('<?php echo fixEncoding($helptext);?>');
							});
                    ...
                    <td>
						...
						$(document).ready(function() {
							$('#loc_contact_email').focus(function () {
								...
								$('#textloc_contact_email').html('<?php echo fixEncoding($helptext);?>');
							});
                    ...
                    <td>
						...
						$(document).ready(function() {
							$('#loc_contact_url').focus(function () {
								...
								$('#textloc_contact_url').html('<?php echo fixEncoding($helptext);?>');
