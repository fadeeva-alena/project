...
if("SUCCESS" == strtoupper($httpParsedResponseAr["ACK"]) || "SUCCESSWITHWARNING" == strtoupper($httpParsedResponseAr["ACK"])) {
  ...
  if ($_REQUEST['access_num'] == 1){
	...
	if (mysql_num_rows($sqlcheckfirst) > 0){
		...
		$billingtop = "<div style=float:left;><img src='http://manimano.ch/wlw/images/header-logo.png'><br />Address Here...</div>";
		$billingtop .= "<br style='clear:both;'><hr><br />";
		...
		$bodyemail = str_replace("<firstname> <lastname>","<div style='float:right;'><b>".genderfields($gender) . " " . $row->firstname ." " . $row->lastname."</b></div>",$bodyemail);
