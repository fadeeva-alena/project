...
<link href="plugins/jquery/fancybox/jquery.fancybox-1.3.1.css" rel="stylesheet" type="text/css" /> 
     ...
     {display: '<?php echo $fieldname_de;?>', name : 'kind_de', width : 160, sortable : true, align: 'left'},
     {display: '<?php echo $fieldname_en;?>', name : 'kind_eng', width : 160, sortable : true, align: 'left'},
	 {display: '<?php echo $fieldname_fr;?>', name : 'kind_fr', width : 160, sortable : true, align: 'left'},
     {display: '<?php echo $fieldname_it;?>', name : 'kind_it', width : 160, sortable : true, align: 'left'}
     ],
	 buttons : 
     [
     <?php
     ...
     sortname: "<?php echo $fg_event_kind['sortname']?>",
     sortorder: "<?php echo $fg_event_kind['sortorder']?>",
     usepager: true,
     title: '<?php echo str_replace("'","",$page_heading);?>',
     useRp: true,
     rp: <?php echo $fg_event_kind['rp']?>,
     rpOptions: <?php echo $fg_event_kind['rpOptions']?>,
     showTableToggleBtn: <?php echo $fg_event_kind['showTableToggleBtn']?>,
     width: 'auto',
     height: '<?php echo $fg_event_kind['height']?>',
     resizable: <?php echo $fg_event_kind['resizable']?>,
