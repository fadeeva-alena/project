...
function openCenteredWindow(url) {
	...
	<tr>
		...
		<td><a style="cursor:pointer;" onclick="<?php if ($_GET['quality'] == 1){?>getnoquality(1)<?php }else {?>getquality(1)<?php } ?>" alt="<?php echo $quality1?>" title="<?php echo $quality1?>"><img src="images/1.png"<?php if ($_GET['quality']==1){echo 'style="opacity:0.1;border:2px solid darkblue;"';}?>></a></td>
