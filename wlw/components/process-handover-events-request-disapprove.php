...
$countxx++;
	...
	$reason = $_REQUEST['reason'];
		...
		//mysql_query("update t_event set provider='$provider_id' where id='$eventsid'");
		mysql_query("update t_handover_events set request_status='disapproved',reason='$reason' where id='$id'");
	...
	//sending an email here
			...
			$sqlfield = mysql_query("select * from t_field_names where id=640");
			$rowfield = mysql_fetch_array($sqlfield);
			if ($_SESSION[WEBSITE_ALIAS]['language'] ==1){
