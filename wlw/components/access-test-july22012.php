...
$(document).ready(function() {
	...
	<form name="payform" action="index.php?option=access-test&task=booked" method="post" id="payform" style="display:none;">
		<table class="record-list" width="300">
		<tbody>
			<tr>
			...
			<tr>
				<td><b><?php echo translatefields(807);?></b> <span style=" font:7pt arial; color:gray;">[ mm / yyyy ]</span></td><td><input name="cardmonth" class="sel" type="text" style="width:25px;" value="07" />&nbsp;
				<input type="text" name="cardyear" class="sel" style=" width:50px;" value="2017"></td>	
			</tr>
			<tr class="row1">
				<td><b><?php echo translatefields(808);?></b></td><td><input name="cardcvv" type="text" value=""></td>	
			</tr>
			<tr>
