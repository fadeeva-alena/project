...
<div class="content-main wide80">
    ...
    <?php
        ...
        while ($rowall = mysql_fetch_array($sqlall)){
        ?>
            <td><?php if ($rowall['company'] != ""){?><input type="radio" name="company" value="<?php echo $rowall['company'];?>" />&nbsp;<?php } echo $rowall['company'];?></td>
        <?php 
        }
    } ?>                                                                                                    
                </tr>
    ...
    ?>
        ...
        while ($rowall = mysql_fetch_array($sqlall)){
        ?>
            <td><?php if ($rowall['gender'] > 0){?><input type="radio" name="gender" value="<?php echo $rowall['gender'];?>" />&nbsp;<?php }  
    ...
    <?php
        ...
        while ($rowall = mysql_fetch_array($sqlall)){
        ?>
            <td><?php if ($rowall['firstname'] != ""){?><input type="radio" name="firstname" value="<?php echo $rowall['firstname'];?>" />&nbsp;<?php }  echo $rowall['firstname'];?></td>
        <?php 
        }
    } ?>                                                                                                     
                </tr>
    ...
    <?php
        ...
        while ($rowall = mysql_fetch_array($sqlall)){
        ?>
            <td><?php if ($rowall['lastname'] != ""){?><input type="radio" name="lastname" value="<?php echo $rowall['lastname'];?>" />&nbsp;<?php }  echo $rowall['lastname'];?></td>
        <?php 
        }
    } ?>                                                                                                      
                </tr>
    ...
    <?php
        ...
        while ($rowall = mysql_fetch_array($sqlall)){
        ?>
            <td><?php echo $rowall['image_path'];?></td>
        <?php 
        }
    } ?>  
      </tr>
    ...
    <?php
        ...
        while ($rowall = mysql_fetch_array($sqlall)){
        ?>
            <td><?php if ($rowall['about'] != ""){?><input type="radio" name="about" value="<?php echo $rowall['about'];?>" />&nbsp;<?php }  echo $rowall['about'];?></td>
        <?php 
        }
    } ?>                                                                                                     
                </tr>
    ...
    <?php
        ...
        while ($rowall = mysql_fetch_array($sqlall)){
        ?>
            <td><?php if ($rowall['contact_tel'] != ""){?><input type="radio" name="contact_tel" value="<?php echo $rowall['contact_tel'];?>" />&nbsp;<?php }  echo $rowall['contact_tel'];?></td>
        <?php 
        }
    } ?>                                                                                                      
                </tr>
    ...
    <?php
        ...
        while ($rowall = mysql_fetch_array($sqlall)){
        ?>
            <td><?php if ($rowall['contact_email'] != ""){?><input type="radio" name="contact_email" value="<?php echo $rowall['contact_email'];?>" />&nbsp;<?php }  echo $rowall['contact_email'];?></td>
        <?php 
        }
    } ?>                                                                                                    
                </tr>
    ...
    <?php
        ...
        while ($rowall = mysql_fetch_array($sqlall)){
        ?>
            <td><?php if ($rowall['contact_url'] != ""){?><input type="radio" name="contact_url" value="<?php echo $rowall['contact_url'];?>" />&nbsp;<?php }  echo $rowall['contact_url'];?></td>
        <?php 
        }
    } ?>                                                                                                    
                </tr>
