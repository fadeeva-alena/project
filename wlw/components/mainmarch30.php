...
INSERT INTO `wu_db`.`t_field_names` (`id`, `fieldname`, `fieldname_de`, `fieldname_eng`, `fieldname_fr`, `fieldname_it`, `helptext_de`, `helptext_eng`, `helptext_fr`, `helptext_it`, `table`) VALUES ('698', 'Handle Feedback mails?', 'Handle Feedback mails?', 'Handle Feedback mails?', 'Handle Feedback mails?', 'Handle Feedback mails?', 'Handle Feedback mails?', 'Handle Feedback mails?', 'Handle Feedback mails?', 'Handle Feedback mails?', '11');

INSERT INTO `wu_db`.`t_field_names` (`id`, `fieldname`, `fieldname_de`, `fieldname_eng`, `fieldname_fr`, `fieldname_it`, `helptext_de`, `helptext_eng`, `helptext_fr`, `helptext_it`, `table`) VALUES ('699', 'Please login before you can give your feedback.', 'Please login before you can give your feedback.', 'Please login before you can give your feedback.', 'Please login before you can give your feedback.', 'Please login before you can give your feedback.', 'Please login before you can give your feedback.', 'Please login before you can give your feedback.', 'Please login before you can give your feedback.', 'Please login before you can give your feedback.', '11');
	*/
	if ($page_option == ""){
		$page_option = "events";
	}
