...
// Retrieve record
	...
	?>	
		...
		$sqlfield = mysql_query("select * from t_field_names where id=674");
		$rowfield = mysql_fetch_array($sqlfield);
		if ($_SESSION[WEBSITE_ALIAS]['language'] ==1){
		$helptext = $rowfield['helptext_de'];
		}elseif ($_SESSION[WEBSITE_ALIAS]['language'] ==2){
		...
		$helptext = fixEncodingx($helptext);
		}
		...
		$sqlfield = mysql_query("select * from t_field_names where id=671");
		$rowfield = mysql_fetch_array($sqlfield);
		if ($_SESSION[WEBSITE_ALIAS]['language'] ==1){
		$helptext = $rowfield['helptext_de'];
		}elseif ($_SESSION[WEBSITE_ALIAS]['language'] ==2){
...
$iframesettings2 = mysql_query("select * from t_iframe_settings where frame_id=0 and provider_id=''");
	...
	$newheight = 310 + $iframe_height;
			?>
			<iframe width="600px" height="<?php echo $newheight;?>px" src="http://manimano.ch/wlw/demo.php?events_id=<?php echo $id;?>" frameborder="0" allowfullscreen  style="overflow-x:hidden;"></iframe>
			</td>
		</tr>
