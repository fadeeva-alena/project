...
$administrator_id = $_SESSION[WEBSITE_ALIAS]['admin_id'];
    ...
    <form action="<?php echo INDEX_PAGE . $page_option; ?>" method="post" id="frm_<?php echo $page_name; ?>">
        ...
        <fieldset class="standard-form">
            ...
            <table class="form-table wide100">       
                ...
                <?php if ( !$is_editable_field ) { ?>
                <tr>
                    <td class="key"><label for="Password">Password <?php echo $req_fld?></label></td>                   
                    <td>- Not Shown -</td>
                </tr>   
                <?php } ?>                                          
                <?php if ( $is_editable_field ) { ?>
                <tr>
                    <td class="key"><label for="Password">Current Password <?php echo $req_fld?></label></td>                   
                    <td>
                ...
                <?php } ?>                                          
               	<?php if ( $is_editable_field ) { ?>                                                                                                    
                <tr>
                    <td class="key"><label for="Password">New Password <?php echo $req_fld?></label></td>
                    <td>
                ...
                <?php if ( $is_editable_field ) { ?>                                          
                <tr>
                    <td class="key"><label for="Password2">Verify New Password <?php echo $req_fld?></label></td>
                    <td>
