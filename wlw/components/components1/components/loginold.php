...
<table width="930px" style="margin: 0 auto;">
	...
	?>
	<div style="float:right;border:0px solid red;margin-top:0px;width:400px;" id="load-desc">
	...
	<table width="500" height="300px" style="font-size:11px;size:11px;margin-top:-3px;margin-left:0px;">
	<tr>
		<td height="5px;"></td>
	</tr>
	<tr>
		<td>
			...
			<table cellspacing="0" width="500" height="300px" class="calendar" cellspacing="3" cellpadding="3px" style="background-color:white;font-size:11px;border-collapse:collapse;border:1px solid #010102;" border="1">
