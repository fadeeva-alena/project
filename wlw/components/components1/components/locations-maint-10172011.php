    ...
    <form action="<?php echo INDEX_PAGE . $page_option ?>" method="post" id="frm_<?php echo $page_name?>"  enctype="multipart/form-data">
        ...
        <fieldset class="standard-form">
			...
			<script>
				function suggest(inputString){
					...
					function fill(thisValue) {
						var fetch = new String(thisValue);
			...
			<tr>
                    ...
                    <?php if ( $is_editable_field ) { ?>
                    <td>
                    	<input onkeyup="suggest(this.value);" onblur="fill();" autocomplete="off" type="text" name="loc_zip" id="loc_zip" size="50" maxlength="150" value="<?php echo htmlentities($loc_zip)?>" />
        ...
        <div class="suggestionList" id="suggestionsList"> &nbsp; </div></div>
			...
			<tr>
                    ...
                    <?php if ( $is_editable_field ) { ?>
                    <td>
                    	<input type="text" onkeyup="suggest1(this.value);" onblur="fill1();"  autocomplete="off" name="loc_loc" id="loc_loc" size="50" maxlength="150" value="<?php echo htmlentities($loc_loc)?>" />
