        ...
        <form method="post" id="frmLogin" action="">
            <div class="login-content-main">
				...
				<div style="float:left;margin-top:10px;margin-bottom:10px;">
					<h2 style="font-size:20px;padding:0px;margin:0px;">Login</h2>
				</div>
                <div style="float:left;margin-left:40px;margin-top:18px;">
                ...
                <div class="clr"></div>
                <div align="center"><a href="index.php?option=forgotpassword">Forgot Password</a> | <a href="index.php?option=users&mode=add">Create new account</a></div>
            </div>
        </form>
			...
			<table cellspacing="0" width="350" height="200px" class="calendar" cellspacing="3" cellpadding="3px" style="background-color:white;font-size:11px;border-collapse:collapse;border:1px solid #010102;" border="1">
				<tr style="background-color:#595A5A;color:white;height:20px;border:0px;">
					...
					<td colspan="7">
						<table width="100%">
							<tr>
								<td><a style="color:white;text-decoration:none;font-size:16px;" href="<?php echo $_SERVER['PHP_SELF']?>?option=login&time=<?php echo $previous_year?>" title="<?php echo $previous_year_text?>">&laquo;&laquo;</a></td>
					<td><a style="color:white;text-decoration:none;font-size:16px;" href="<?php echo $_SERVER['PHP_SELF']?>?option=login&time=<?php echo $previous_month?>" title="<?php echo $previous_month_text?>">&laquo;</a></td>
