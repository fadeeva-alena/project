	...
	<form id="frm_customsearch">
		...
		?>	
			...
			<table align="left">
				<tr>
					<td align="left">
						<a href="<?php echo INDEX_PAGE.$page_option; ?>&optionlist=0&optionlistfilter=0"<?php if ($_SESSION['optionlist'] == 0 and $_SESSION['optionlistfilter'] == 0){echo " style=font-weight:bold;";}?>>All Entries, all Dates </a>
					</td>
					<td rowspan="2" align="center">
						<span style="font-size:20px;size:30px;color:#eeeeee;">|</span>
					</td>
					<td align="left">
						<a href="<?php echo INDEX_PAGE.$page_option; ?>&optionlist=1&optionlistfilter=0"<?php if ($_SESSION['optionlist'] == 1 and $_SESSION['optionlistfilter'] == 0){echo " style=font-weight:bold;";}?>>My Entries, all Dates </a>
					</td>
					<td rowspan="2" align="center">
						<span style="font-size:20px;size:30px;color:#eeeeee;">|</span>
					</td>
					<td align="center" valign="middle" rowspan="2">
						...
						<a href="index.php?option=events-calendar"><img src="images/calendar.gif" border="0"/>
						Events Calendar</a>
						</div>
					</td>
				</tr>
				...
				<tr>
					<td align="left">
						<a href="<?php echo INDEX_PAGE.$page_option; ?>&optionlist=0&optionlistfilter=1"<?php if ($_SESSION['optionlist'] == 0 and $_SESSION['optionlistfilter'] == 1){echo " style=font-weight:bold;";}?>>All Entries, Today and Future </a>
					</td>
					<td align="left">
						<a href="<?php echo INDEX_PAGE.$page_option; ?>&optionlist=1&optionlistfilter=1"<?php if ($_SESSION['optionlist'] == 1 and $_SESSION['optionlistfilter'] == 1){echo " style=font-weight:bold;";}?>> My Entries, Today and Future </a>
					</td>
				</tr>
			</table>
			</p>
