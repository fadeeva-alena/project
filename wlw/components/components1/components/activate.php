		...
		if ( $table_name == DB_TABLE_PREFIX.'administrators' ) {
			...
			switch ($table_name)
			{
				...
				case DB_TABLE_PREFIX.'members':
						...
						$subject = "satsunfun.com: Your account was ACTIVATED!";
						...
						$message = $row['username'] ." account was ACTIVATED.<br /><br /> Please contact us for more inquiries at <a href='mailto:info@satsunfun.com'>info@satsunfun.com</a>.";
						
						$mail = @mail($to, $subject, $message, $headers);
						
						$update = mysql_query("update tbl_members set is_activated=1 where member_id='$record_id'");
						if ($update > 0){
							$count_deleted = 1;
						}else{
							$count_deleted = 0;
...
$result = 'There are <strong style="font-size:1.5em; color:red;">'.$total_deleted.'</strong> of '.$total_ids.' member(s) ACTIVATED!';		
