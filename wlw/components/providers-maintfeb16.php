...
.ac_over {
	...
	<div style="display:none;float:right;width:220px;z-index:10000;position:absolute;margin-left:200px;margin-top:-18px;border:0px solid red;" id="textreminder"></div>
	  ...
	  ?>
		...
		<tr>
			<td>
			<iframe width="600px" height="300px" src="http://manimano.ch/wlw/demo-2.php?provider_id=<?php echo $id;?>" frameborder="0" allowfullscreen  style="overflow-x:hidden;"></iframe>
			</td>
		</tr>
