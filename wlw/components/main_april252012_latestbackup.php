...
INSERT INTO `wu_db`.`t_field_names` (`id`, `fieldname`, `fieldname_de`, `fieldname_eng`, `fieldname_fr`, `fieldname_it`, `helptext_de`, `helptext_eng`, `helptext_fr`, `helptext_it`, `table`) VALUES ('743', 'Obwohl wir über 10,000 Einträge haben, gibt es für diese Suche kein Ergebnis. Suchen sie allgemeiner / entfernen Sie einen der Suchbegriffe', 'Obwohl wir über 10,000 Einträge haben, gibt es für diese Suche kein Ergebnis. Suchen sie allgemeiner / entfernen Sie einen der Suchbegriffe', 'though we have more than 10,000 entries, we dont have a match, please make your search less specific.', 'Obwohl wir über 10,000 Einträge haben, gibt es für diese Suche kein Ergebnis. Suchen sie allgemeiner / entfernen Sie einen der Suchbegriffe', 'Obwohl wir über 10,000 Einträge haben, gibt es für diese Suche kein Ergebnis. Suchen sie allgemeiner / entfernen Sie einen der Suchbegriffe', 'Obwohl wir über 10,000 Einträge haben, gibt es für diese Suche kein Ergebnis. Suchen sie allgemeiner / entfernen Sie einen der Suchbegriffe', 'Obwohl wir über 10,000 Einträge haben, gibt es für diese Suche kein Ergebnis. Suchen sie allgemeiner / entfernen Sie einen der Suchbegriffe', 'Obwohl wir über 10,000 Einträge haben, gibt es für diese Suche kein Ergebnis. Suchen sie allgemeiner / entfernen Sie einen der Suchbegriffe', 'Obwohl wir über 10,000 Einträge haben, gibt es für diese Suche kein Ergebnis. Suchen sie allgemeiner / entfernen Sie einen der Suchbegriffe', '11');

INSERT INTO `wu_db`.`t_field_names` (`id`, `fieldname`, `fieldname_de`, `fieldname_eng`, `fieldname_fr`, `fieldname_it`, `helptext_de`, `helptext_eng`, `helptext_fr`, `helptext_it`, `table`) VALUES ('744', 'Jede Veranstaltung hat eine Qualität - um erfolgreich zu suchen benötigen Sie mindestens eine Qualität - aktivieren Sie zuerst eine andere, dann können Sie die gewählte abschalten.', 'Jede Veranstaltung hat eine Qualität - um erfolgreich zu suchen benötigen Sie mindestens eine Qualität - aktivieren Sie zuerst eine andere, dann können Sie die gewählte abschalten.', 'Jede Veranstaltung hat eine Qualität - um erfolgreich zu suchen benötigen Sie mindestens eine Qualität - aktivieren Sie zuerst eine andere, dann können Sie die gewählte abschalten.', 'Jede Veranstaltung hat eine Qualität - um erfolgreich zu suchen benötigen Sie mindestens eine Qualität - aktivieren Sie zuerst eine andere, dann können Sie die gewählte abschalten.', 'Jede Veranstaltung hat eine Qualität - um erfolgreich zu suchen benötigen Sie mindestens eine Qualität - aktivieren Sie zuerst eine andere, dann können Sie die gewählte abschalten.', 'Jede Veranstaltung hat eine Qualität - um erfolgreich zu suchen benötigen Sie mindestens eine Qualität - aktivieren Sie zuerst eine andere, dann können Sie die gewählte abschalten.', 'Jede Veranstaltung hat eine Qualität - um erfolgreich zu suchen benötigen Sie mindestens eine Qualität - aktivieren Sie zuerst eine andere, dann können Sie die gewählte abschalten.', 'Jede Veranstaltung hat eine Qualität - um erfolgreich zu suchen benötigen Sie mindestens eine Qualität - aktivieren Sie zuerst eine andere, dann können Sie die gewählte abschalten.', 'Jede Veranstaltung hat eine Qualität - um erfolgreich zu suchen benötigen Sie mindestens eine Qualität - aktivieren Sie zuerst eine andere, dann können Sie die gewählte abschalten.', '11');
