...
<td style="background:url('images/menubar.png');">
    ...
    <div id="navigation" style="width:1250;margin:0 auto;float:none;border:border:0px solid red;">
    
    
    <ul class="sf-menu" style="width:1250px;margin:0 auto;float:none;border:0px solid red;">
...
<?php
	...
	/*
	INSERT INTO `wu_db`.`t_field_names` (`id`, `fieldname`, `fieldname_de`, `fieldname_eng`, `fieldname_fr`, `fieldname_it`, `helptext_de`, `helptext_eng`, `helptext_fr`, `helptext_it`, `table`) VALUES ('605', 'leitung zusammenlegen', 'leitung zusammenlegen', 'leitung zusammenlegen', 'leitung zusammenlegen', 'leitung zusammenlegen', 'leitung zusammenlegen', 'leitung zusammenlegen', 'leitung zusammenlegen', 'leitung zusammenlegen', '11');
