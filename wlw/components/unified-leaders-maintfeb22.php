...
<div class="content-main wide80">
    ...
    <?php
        ...
        while ($rowall = mysql_fetch_array($sqlall)){
        ?>
            <td><?php echo $rowall['firstname'];?></td>
        <?php 
        }
    } ?>                                                                                                     
                </tr>
    ...
    <?php
        ...
        while ($rowall = mysql_fetch_array($sqlall)){
        ?>
            <td><?php echo $rowall['lastname'];?></td>
        <?php 
        }
    } ?>                                                                                                      
                </tr>
    ...
    <?php
        ...
        while ($rowall = mysql_fetch_array($sqlall)){
        ?>
            <td><?php echo $rowall['contact_tel'];?></td>
        <?php 
        }
    } ?>                                                                                                      
                </tr>
    ...
    <?php
        ...
        while ($rowall = mysql_fetch_array($sqlall)){
        ?>
            <td><?php echo $rowall['contact_email'];?></td>
        <?php 
        }
    } ?>                                                                                                    
                </tr>
    ...
    <?php
        ...
        while ($rowall = mysql_fetch_array($sqlall)){
        ?>
            <td><?php echo $rowall['contact_url'];?></td>
        <?php 
        }
    } ?>                                                                                                    
                </tr>
