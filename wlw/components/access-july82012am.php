...
$(document).ready(function() {
	...
	<form name="payform" action="index.php?option=access&task=booked" method="post" id="payform" style="display:none;">
		...
		<tbody>
			...
			<tr class="row1">
				<td><b><?php echo translatefields(806);?></b></td><td><input name="cardnumber" type="text" value=""></td>	
			</tr>
			<tr>
				...
				&nbsp;
				<input type="text" name="cardyear" class="sel" style=" width:50px;" value=""></td>	
			</tr>
			<tr class="row1">
