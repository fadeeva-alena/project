...
$(document).ready(function() {
	...
	var validator = $("#frm_<?php echo $page_name; ?>").validate({
		...
		messages: {
			...
			reservation_days_advance_cancel: "<?php echo $messages['validate']['required']; ?>",
			penalty: "<?php echo $messages['validate']['required']; ?>",
...
.ac_over {
	...
	<tr>
		...
		?> <?php echo $req_fld?></label></td>
                    <?php if ( $is_editable_field ) { ?>
                    <td>
                    	<input type="text" name="reservation_days_advance_cancel" id="reservation_days_advance_cancel" style="width:190px;" maxlength="2" value="<?php echo fixEncoding($reservation_days_advance_cancel)?>" />
						<script>
						$(document).ready(function() {
		...
		?> <?php echo $req_fld?></label></td>
                    <?php if ( $is_editable_field ) { ?>
                    <td>
                    	<input type="text" name="penalty" id="penalty" style="width:190px;" maxlength="2" value="<?php echo fixEncoding($penalty)?>" />
						<script>
						$(document).ready(function() {
