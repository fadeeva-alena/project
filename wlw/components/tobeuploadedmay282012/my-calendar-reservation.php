...
if (isset($_GET['delete_reservation_id'])){
	...
	header("Location: ".INDEX_PAGE."my-calendar-reservation&a=delete&success=true&start=".$_SESSION['sessionreservationstartdate']."&end=".$_SESSION['sessionreservationenddate']);
	}else{
