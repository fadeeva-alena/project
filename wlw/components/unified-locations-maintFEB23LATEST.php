...
if ( $form_action != '' ) {
    ...
    $countx++;
	   ...
	   if ($_POST['loc_shortdesc'.$countx]){ $concatshort .=$_POST['loc_shortdesc'.$countx]."<br />";}
    ...
    <?php if ( $is_editable_field ) { ?>
        ...
        <?php } else { 
            ...
            while ($rowall = mysql_fetch_array($sqlall)){
                ...
                if ($countx == 1){$checkeddefault = " checked=checked";}else{$checkeddefault='';}
                ?>
                <td><?php if ($rowall['loc_adress1'] != ""){?><input type="radio" <?php echo $checkeddefault;?> class="column<?php echo $countx;?>" name="loc_adress1" value="<?php echo $rowall['loc_address1'];?>" />&nbsp;<?php } echo $rowall['loc_adress1'];?></td>
                <?php 
            }
        } ?>                                                                                                
    </tr>
