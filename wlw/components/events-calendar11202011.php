...
$().ready(function() {
	...
	$("#frm_customsearch input").keypress(function (e) {  
		...
		$('#calendar').hide();
		$.ajax({
		  url: "components/calendar-new.php?time=<?php echo $time;?>&datetocheck="+currentdate+"&quality1="+quality1+"&quality2="+quality2+"&quality3="+quality3+"&quality4="+quality4+"&quality5="+quality5+"&location="+location+"&keyword="+keyword,
		  cache: false,
		  success: function(html){
			$('#calendar').show();
			$("#calendar").html(html);
