...
session_start();
	...
	$size_row = mysql_fetch_array($getnum);
	 ...
	 echo $size_row['title'] . " [".$size_row['events_start_date']." - " . $size_row['events_end_date'] ."] " .$page_heading?></h1>
...
<link href="plugins/jquery/fancybox/jquery.fancybox-1.3.1.css" rel="stylesheet" type="text/css" /> 
     ...
     {display: '<?php echo $fieldname_de;?>', name : 'eventtype_de', width : 160, sortable : true, align: 'left'},
     {display: '<?php echo $fieldname_en;?>', name : 'eventtype_eng', width : 160, sortable : true, align: 'left'},
	 {display: '<?php echo $fieldname_fr;?>', name : 'eventtype_fr', width : 160, sortable : true, align: 'left'},
     {display: '<?php echo $fieldname_it;?>', name : 'eventtype_it', width : 160, sortable : true, align: 'left'}
     ],
	 buttons : 
     [
     <?php
     ...
     sortname: "<?php echo $fg_event_type['sortname']?>",
     sortorder: "<?php echo $fg_event_type['sortorder']?>",
     usepager: true,
     title: '<?php echo str_replace("'","",$page_heading);?>',
     useRp: true,
     rp: <?php echo $fg_event_type['rp']?>,
     rpOptions: <?php echo $fg_event_type['rpOptions']?>,
     showTableToggleBtn: <?php echo $fg_event_type['showTableToggleBtn']?>,
     width: '<?php echo $fg_event_type['width']?>',
     height: 'auto',
     resizable: <?php echo $fg_event_type['resizable']?>,
