...
.ac_over {
	...
	<tr>
		...
		?> <?php echo $req_fld?></label></td>
				...
				<input type="hidden" id="locid" name="locationid" value="<?php echo $record->location;?>" />
		...
		?><?php echo $req_fld?></label></td>
			 <?php if ( $is_editable_field ) { ?>
				...
				<input type="hidden" id="leader1id" name="leader1id" value="<?php echo $record->leader;?>" />
		...
		?></label></td>
			 <?php if ( $is_editable_field ) { ?>
				...
				<input type="hidden" id="leader2id" name="leader2id" value="<?php echo $record->leader2;?>" />
