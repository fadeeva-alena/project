...
$post_data['provider'] = $_SESSION[WEBSITE_ALIAS]['admin_id'];
	...
	$sql = mysql_query("SELECT id,concat(loc_name ,', ',loc_detail,' ',loc_adress1, ' ',loc_adress2,' ',loc_zip,' ', loc_loc) as locname  FROM ".DB_TABLE_PREFIX."location where id='$id'");	
	$row = mysql_fetch_array($sql);
	echo $row['id'] ."~" . $row['locname'];
