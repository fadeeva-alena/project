...
<script type='text/javascript'>
	...
	$(document).ready(function() {
		...
		$('#calendar').fullCalendar({
			...
			?>
				{
					<?php if ($_SESSION[WEBSITE_ALIAS]['admin_id']==$rowreservations["reservation_provider_id"]){?>
					...
					allDay: false,
					<?php if ($_SESSION[WEBSITE_ALIAS]['admin_id']==$rowreservations["reservation_provider_id"]){?>color: '#<?php echo fixEncoding($rowreservations["provider_event_color"]);?>',qtipclickable:1,<?php } else{ ?>color: '#aaaaaa',qtipclickable:0,<?php } ?>
