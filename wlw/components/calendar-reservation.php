...
// use the element's text as the event title 
				title: $.trim($(this).find('.actualTitle').text()), 
...
?>
	<div class='external-event' price="<?php echo translatefields(8);?></b>: <?php echo $rowproviderevents['provider_event_price'] . " " . $rowproviderevents['currency'];?>" title="<?php echo $rowproviderevents['provider_event_description'];?><br/><b><?php echo translatefields(8);?></b>: <?php echo $rowproviderevents['provider_event_price'] . " " . $rowproviderevents['currency'];?>" <?php if ($rowproviderevents['provider_event_color'] != ""){echo 'style="'.$gettextcolor.'background-color:#'.$rowproviderevents['provider_event_color'].$foreventheight.';"';}?>><?php echo $rowproviderevents['provider_event_title'];?><br /><?php echo translatefields(718) . ": " . $provider_event_duration;?><br /><?php echo $rowproviderevents['provider_event_price'] . " " . $rowproviderevents['currency'];?> <span style="color:#<?php echo $rowproviderevents['provider_event_color'];?>;font-color:#<?php echo $rowproviderevents['provider_event_color'];?>"> ~ <?php echo $rowproviderevents['provider_event_title'];?></span>
	...
	<span class="actualTitle"><?php echo $rowproviderevents['provider_event_title'];?></span>
</div>
<?php
	}
?>
