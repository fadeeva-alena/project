...
//sending an email here
			...
			//storniert
			//
			$bodyemail = str_replace("Wir w&#252;nschen viel Spass und eine gelungene Session.<br>","<b>Wir w&#252;nschen viel Spass und eine gelungene Session.<br></b>",$bodyemail);
...
<script type='text/javascript'>
	...
	$(document).ready(function() {
		...
		$('#calendar').fullCalendar({
			...
			events: [
			<?php $sqlreservations = mysql_query("select * from t_provider_events pe inner join t_provider_reservation pr on pe.provider_event_id=pr.provider_event_id inner join t_currency c on c.id=pe.provider_event_price_currency where reservation_status=1 and pe.provider_id='".$_SESSION['ownerproviderid']."'");
			$ctrevent = 0;while ($rowreservations = mysql_fetch_array($sqlreservations)){$ctrevent++;
...
?>
	<div class='external-event' price="<?php echo translatefields(8);?></b>: <?php echo $rowproviderevents['provider_event_price'] . " " . $rowproviderevents['currency'];?>" title="<?php echo $rowproviderevents['provider_event_description'];?><br/><b><?php echo translatefields(8);?></b>: <?php echo $rowproviderevents['provider_event_price'] . " " . $rowproviderevents['currency'];?>" <?php if ($rowproviderevents['provider_event_color'] != ""){echo 'style="'.$textcolor.'background-color:#'.$rowproviderevents['provider_event_color'].';"';}?>><?php echo $rowproviderevents['provider_event_title'];?></div>
<?php
	}
?>
<script type="text/javascript">
