...
$sqlevents = mysql_query("select * from t_event where provider='".$_GET['id']."'");

$sqlpro = mysql_query("select * from t_provider where id='".$_GET['id']."'");
$rowpro = mysql_fetch_array($sqlpro);
$owner = $rowpro['firstname'] . " " . $rowpro['lastname'] . "'s ";
}
...
while ($rowevent = mysql_fetch_array($sqlevents)){
