...
//add_leader_option
    ...
    header("Location: ".INDEX_PAGE."events-3&providername=".$_POST['providername']."&search_keyword=".$_POST['search_keyword']."&a=add&success=".$result);
    }elseif($_REQUEST['trigger_prev'] == 1 and $_REQUEST['trigger_next'] == 0){
    $prevurl = $_REQUEST['prev_url'];
    header("Location: ".$prevurl."&events-3&providername=".$_POST['providername']."&search_keyword=".$_POST['search_keyword']."&a=add&mode=edit&success=".$result);
    //header("Location: ".$prevurl."&events-3&providername=".$_POST['providername']."&search_keyword=".$_POST['search_keyword']."&a=edit&success=".$result);
    ...
    //header("Location: ".$nexturl."&events-3&providername=".$_POST['providername']."&search_keyword=".$_POST['search_keyword']."&a=edit&success=".$result);
}
		break;
		...
		//header("Location: ".INDEX_PAGE."events-3&a=edit&success=".$result);
		...
		if ($_REQUEST['trigger_prev'] == 0 and $_REQUEST['trigger_next'] == 0){
			header("Location: ".INDEX_PAGE."events-3&providername=".$_POST['providername']."&search_keyword=".$_POST['search_keyword']."&a=edit&success=".$result);
		}elseif($_REQUEST['trigger_prev'] == 1 and $_REQUEST['trigger_next'] == 0){
			$prevurl = $_REQUEST['prev_url'];
			header("Location: ".$prevurl."&events-3&providername=".$_POST['providername']."&search_keyword=".$_POST['search_keyword']."&a=edit&mode=edit&success=".$result);
			//header("Location: ".$prevurl."&events-3&providername=".$_POST['providername']."&search_keyword=".$_POST['search_keyword']."&a=edit&success=".$result);
		}elseif($_REQUEST['trigger_prev'] == 0 and $_REQUEST['trigger_next'] == 1){
			$nexturl = $_REQUEST['next_url'];
		...
		header("Location: ".INDEX_PAGE."events-3&providername=".$_POST['providername']."&search_keyword=".$_POST['search_keyword']."&a=delete&success=".$result);
		} elseif ( $_POST["Delete"] == $no ) {
		header("Location: ".INDEX_PAGE."events-3&providername=".$_POST['providername']."&search_keyword=".$_POST['search_keyword']);
		} else { 
		header("Location: ".INDEX_PAGE."events3-m&providername=".$_POST['providername']."&search_keyword=".$_POST['search_keyword']."&id=".$id);
		}	
		break;
...
.ac_over {
	...
	<?php
		...
		location.href = '<?php echo INDEX_PAGE."events-3&providername=".$_REQUEST['providername']."&search_keyword=".$_REQUEST['search_keyword']?>';
		});
	...
	<tr>
		...
		?>
		<a href="index.php?option=events3-m&mode=edit&id=<?php echo $id?>&eventsid=<?php echo $eventsid;?>#delete-events" onclick="if(!confirm('<?php echo $delete;?>')){return false;}"><img src="images/x.png" border="0" alt="Remove" title="Remove"></a>
		&nbsp;&nbsp;<span class='validation-status'></span>
...
<script>
		...
		if ($_SESSION[WEBSITE_ALIAS]['language'] ==1){
			...
			$nextlabel = $rowfield['fieldname_it'];
				...
				<input type="hidden" name="prev_url" value="index.php?option=events3-m&mode=<?php echo $mode;?>&id=<?php echo $prev_id;?>&prev=1" />
				...
				?>
				<input type="hidden" name="trigger_prev" id="trigger_prev" value="0" />
				<input type="hidden" name="prev_url" value="index.php?option=events3-m&mode=<?php echo $mode;?>&id=<?php echo $last_resumeid;?>&prev=1" />
			...
			?>
				...
				<input type="hidden" name="trigger_next" id="trigger_next" value="0" />
					<input type="hidden" name="next_url" value="index.php?option=events3-m&mode=<?php echo $mode;?>&id=<?php echo $next_id;?>&next=1" />
