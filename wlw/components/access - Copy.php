	...
	<table class="record-list" width="100%">
		...
		<tbody>
			...
			<tr class="row1">
				...
				<?php }else{
				?>
				<td><input type="button" value="<?php echo translatefields(796);?>" onclick="bookplan(1)" class="button" /></td>
				<?php
				}?>
			</tr>
			<tr>
				...
				<?php }else{
				?>
				<td><input type="button" value="<?php echo translatefields(796);?>" onclick="bookplan(2)" class="button" /></td>
				<?php
				}?>
			</tr>
			<tr class="row1">
				...
				<?php }else{
				?>
				<td><input type="button" value="<?php echo translatefields(796);?>" onclick="bookplan(3)" class="button" /></td>
				<?php
				}?>
			</tr>
			<tr>
				...
				<?php }else{
				?>
				<td><input type="button" value="<?php echo translatefields(796);?>" onclick="bookplan(4)" class="button" /></td>
				<?php
				}?>
			</tr>
		</tbody>
