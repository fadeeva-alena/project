...
?>
    ...
    // {display: '<?php echo $address2;?>', name : 'loc_adress2', width : 93, sortable : true, align: 'center'},
     ...
     return false;
		...
		{
			//var items =$('input[name=locationsid]:radio:checked').length;
			//alert(items);
			...
			if (numSelected > 1){
				...
				//alert(allVals);
				document.location.href='index.php?mode=view&option=unified-locations-m&ids=' + allVals;
			}else{
				alert("<?php echo $atleast2;?>");
			}
