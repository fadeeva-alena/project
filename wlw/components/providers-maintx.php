...
<div class="content-main wide65">
    ...
    ?>
		...
		?><?php echo $req_fld?></label></td>
                    <?php if ( $is_editable_field ) { ?>
                    <td>
                    	<input type="text" name="lastname" id="lastname" size="35" maxlength="150" value="<?php echo htmlentities($lastname)?>" />
                        <span class="validation-status"></span>
						<script>
						$(document).ready(function() {
		...
		?></label></td>
				...
				<tr>
                    ...
                    <?php if ( $is_editable_field ) { ?>
                    <td>
                    	<input type="text" name="contact_div" id="contact_div" size="35" maxlength="150" value="<?php echo htmlentities($contact_div)?>" />
