...
if ( $form_action != '' ) {
                ...
                while ($rowsave = mysql_fetch_array($sqlsave)){
                    if ($rowsave['id'] != $masterid){
						...
						if ($_POST['loc_shortdesc'] != ""){ $set .="loc_shortdesc='".$_POST['loc_shortdesc'] . "',"; }
...
<tr>
	<td>
                ...
                while ($rowall = mysql_fetch_array($sqlall)){
                    ...
                    ?>
                    <td align="center">
                    	<input type="radio" name="masterid" value="<?php echo $rowall['id'];?>" <?php echo $checkeddefault;?>/>
                    </td>
                    <?php 
                //}
            } ?>  
...
<?php if ( $is_editable_field ) { ?>
    ...
    <?php
        ...
        ?>
			...
			<input type="radio" name="loc_name" value="<?php echo $rowall['loc_name'];?>" />&nbsp;
			<?php } ?>
...
<?php if ( $is_editable_field ) { ?>
    ...
    <?php } else { 
        ...
        while ($rowall = mysql_fetch_array($sqlall)){
            ...
            <td><?php if ($rowall['loc_detail'] != ""){?><input type="radio" name="loc_detail" value="<?php echo $rowall['loc_detail'];?>" />&nbsp;<?php } echo $rowall['loc_detail'];?></td>
            <?php 
        }
    } ?>                                                                                                
</tr>
...
<?php if ( $is_editable_field ) { ?>
    ...
    <?php } else { 
        ...
        while ($rowall = mysql_fetch_array($sqlall)){
            ?>
            <td><?php if ($rowall['loc_adress1'] != ""){?><input type="radio" name="loc_adress1" value="<?php echo $rowall['loc_address1'];?>" />&nbsp;<?php } echo $rowall['loc_adress1'];?></td>
            <?php 
        }
    } ?>                                                                                                
</tr>
...
<?php if ( $is_editable_field ) { ?>
    ...
    <?php } else { 
        ...
        while ($rowall = mysql_fetch_array($sqlall)){
            ?>
            <td><?php if ($rowall['loc_adress2'] != ""){?><input type="radio" name="loc_adress2" value="<?php echo $rowall['loc_adress2'];?>" />&nbsp;<?php } echo $rowall['loc_adress2'];?></td>
            <?php 
        }
    } ?>                                                                                                
</tr>
...
<?php if ( $is_editable_field ) { ?>
    ...
    <?php } else { 
        ...
        while ($rowall = mysql_fetch_array($sqlall)){
			...
			?>
			<?php if ($rowall['loc_name'] != ""){?>
				<input type="radio" name="loc_country" value="<?php echo $rowall['loc_country'];?>" />&nbsp;
			<?php
				}
...
<?php if ( $is_editable_field ) { ?>
    ...
    <?php } else { 
        ...
        while ($rowall = mysql_fetch_array($sqlall)){
            ?>
            <td><?php if ($rowall['loc_zip'] != ""){?><input type="radio" name="loc_zip" value="<?php echo $rowall['loc_zip'];?>" />&nbsp;<?php } echo $rowall['loc_zip'];?></td>
            <?php 
        }
    } ?>                                                                                                   
</tr>	
...
<?php if ( $is_editable_field ) { ?>
    ...
    <?php } else { 
        ...
        while ($rowall = mysql_fetch_array($sqlall)){
            ?>
            <td><?php if ($rowall['loc_loc'] != ""){?><input type="radio" name="loc_loc" value="<?php echo $rowall['loc_loc'];?>" />&nbsp;<?php } echo $rowall['loc_loc'];?></td>
            <?php 
        }
    } ?>                                                                                                
</tr>	
...
<?php if ( $is_editable_field ) { ?>
    ...
    <?php } else { 
        ...
        while ($rowall = mysql_fetch_array($sqlall)){
            ?>
            <td><?php if ($rowall['loc_shortdesc'] != ""){?><input type="radio" name="loc_shortdesc" value="<?php echo $rowall['loc_shortdesc'];?>" />&nbsp;<?php } echo $rowall['loc_shortdesc'];?></td>
            <?php 
        }
    } ?>                                                                                                
</tr>
    ...
    <?php } else { 
        ...
        while ($rowall = mysql_fetch_array($sqlall)){
            ...
            if ($loc_contact_gender != ""){
				...
				<input type="radio" name="loc_contact_gender" value="<?php echo $rowall['loc_contact_gender'];?>" />&nbsp;
				<?php
				}
                if ($_SESSION[WEBSITE_ALIAS]['language'] ==1){
                    echo $row1['gender_de'];	
...
<?php if ( $is_editable_field ) { ?>
    ...
    <?php } else { 
        ...
        while ($rowall = mysql_fetch_array($sqlall)){
            ...
            <td><input type="radio" name="loc_contact_name" value="<?php echo $rowall['loc_contact_name'];?>" />&nbsp;<?php } echo $rowall['loc_contact_name'];?></td>
            <?php 
        }
    } ?>                                                                                                  
</tr>
...
<?php if ( $is_editable_field ) { ?>
    ...
    <?php } else { 
        ...
        //echo "select * from t_location where id in ($ids)";
        while ($rowall = mysql_fetch_array($sqlall)){
            ?><?php if ($rowall['loc_contact_phone'] != ""){?>
            <td><input type="radio" name="loc_contact_phone" value="<?php echo $rowall['loc_contact_phone'];?>" />&nbsp;<?php } echo $rowall['loc_contact_phone'];?></td>
            <?php 
        }
    } ?>                                                                                                         
</tr>
...
<?php if ( $is_editable_field ) { ?>
    ...
    <?php } else { 
        ...
        while ($rowall = mysql_fetch_array($sqlall)){
            ?>
            <td><?php if ($rowall['loc_contact_email'] != ""){?><input type="radio" name="loc_contact_email" value="<?php echo $rowall['loc_contact_email'];?>" />&nbsp;<?php } echo $rowall['loc_contact_email'];?></td>
            <?php 
        }
    } ?>                                                                                                     
</tr>
...
<?php if ( $is_editable_field ) { ?>
    ...
    <?php } else { 
        ...
        while ($rowall = mysql_fetch_array($sqlall)){
            ?>
            <td><?php if ($rowall['loc_contact_url'] != ""){?><input type="radio" name="loc_contact_url" value="<?php echo $rowall['loc_contact_url'];?>" />&nbsp;<?php } echo $rowall['loc_contact_url'];?></td>
            <?php 
        }
    } ?>                                                                                                        
</tr>
