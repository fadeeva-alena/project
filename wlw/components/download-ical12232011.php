...
if ($_GET['date_id'] != ""){
	...
	$icaldetails .="DTEND;TZID=CET:"  . date('Ymd',strtotime($rowquery['events_end_date']))."T180000\n";
	}
	...
	//$icaldetails .="DTSTART;TZID=CET:".date('Ymd',strtotime($rowquery['events_start_date']))."T180000Z\n";
	$icaldetails .="DTSTART;TZID=CET:" .  date('Ymd',strtotime($rowquery['events_start_date']))."T180000\n";
	}
