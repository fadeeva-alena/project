...
?>
	...
	<div class='external-event' title="<?php echo $rowproviderevents['provider_event_description'];?><br/><b><?php echo translatefields(8);?></b>: <?php echo $rowproviderevents['provider_event_price'] . " " . $rowproviderevents['currency'];?>" <?php if ($rowproviderevents['provider_event_color'] != ""){echo 'style="'.$gettextcolor.'background-color:#'.$rowproviderevents['provider_event_color'].$foreventheight.'"';}?>> <?php echo $rowproviderevents['provider_event_title'];?><br /><?php echo translatefields(718) . ": " . $provider_event_duration;?><br /><?php echo $rowproviderevents['provider_event_price'] . " " . $rowproviderevents['currency'];?><span style="color:#<?php echo $rowproviderevents['provider_event_color'];?>;font-color:#<?php echo $rowproviderevents['provider_event_color'];?>"> ~ <?php echo $rowproviderevents['provider_event_title'];?></span></div><br style="clear:both;">
<?php
...
?>
	<form method="post" action="index.php?option=my-calendar-reservation" id="calendarform">
			...
			<table cellpadding=2 cellspacing=0 width="100%">
				<tr>
					<td width="80px"><b><?php echo translatefields(739);?> </b><?php echo $req_fld; ?></td>
			...
			<tr>
					<td style="width:80px;"><b><?php echo translatefields(750);?> <?php echo translatefields(752);?> </b><?php echo $req_fld; ?></td>
				...
				<tr>
					<td><b><?php echo translatefields(751);?> <?php echo translatefields(752);?> </b><?php echo $req_fld; ?></td>
