...
if ($_REQUEST['task'] == "delete-img"){
		mysql_query("update t_location set loc_image_path='' where id='$id'");
		header("Location: ".INDEX_PAGE."locations-m&providername=".$_REQUEST['providername']."&search_keyword=".$_REQUEST['search_keyword']."&mode=edit&id=".$id."&delimgsuccess=true#deleteimg");
		exit();
	}
...
switch ($form_action)
{
	...
	$sql_helper->insert_all("t_activity_log_content",$post_data_activity_log);
		...
		header("Location: ".INDEX_PAGE."locations&providername=".$_POST['providername']."&search_keyword=".$_POST['search_keyword']."&a=add&success=".$result);
		break;
	...
	case 'EDIT':		
		...
		header("Location: ".INDEX_PAGE."locations&providername=".$_POST['providername']."&search_keyword=".$_POST['search_keyword']."&a=edit&success=".$result);
		break;
	...
	$sql_helper->insert_all("t_activity_log_content",$post_data_activity_log);
			...
			header("Location: ".INDEX_PAGE."locations&providername=".$_POST['providername']."&search_keyword=".$_POST['search_keyword']."&a=delete&success=".$result);
		} elseif ( $_POST["Delete"] == $no ) {
			header("Location: ".INDEX_PAGE."locations&providername=".$_POST['providername']."&search_keyword=".$_POST['search_keyword']);
		} else { 
			header("Location: ".INDEX_PAGE."locations-m&providername=".$_POST['providername']."&search_keyword=".$_POST['search_keyword']."&id=".$id);
		}				
		break;
...
$(document).ready(function() {
	...
	$('#btnCancel').click(function () {
		...
		location.href = '<?php echo INDEX_PAGE."locations&providername=".$_REQUEST['providername']."&search_keyword=".$_REQUEST['search_keyword']?>';
	});
			...
			<?php
				...
				if ($mode == "edit"){
					if ($design_photo_img != ""){
						...
						?>
						<input type="button" value="<?php echo fixEncoding(translatefields(759));?>" onclick="document.location.href='index.php?option=locations-m&providername=<?php echo $_REQUEST['providername'];?>&search_keyword=<?php echo $_REQUEST['search_keyword'];?>&mode=edit&id=<?php echo $id;?>&task=delete-img'" class="button"/><br /><br />
						<?php
					}else{
