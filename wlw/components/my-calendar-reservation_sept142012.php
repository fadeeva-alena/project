							...
							$.ajax({
			  				...
			  				success: function(html){
								if (html == "overlap"){
									...
									$("#loading_img").hide();
									alert('You can not overlap events.');
...
//                                                                                resArr = html.split('|');
//                                                                                resDate2 = resArr[1];
										var durationtime=prompt("<?php echo translatefields2(737);?>","");
										if (durationtime!=null && durationtime!=""){
											if (permanent == 3){
												var durationtimex=prompt("<?php echo translatefields2(746);?>\n","52");
										...
										$.ajax({
											...
											cache: false,
											success: function(html){
												//alert("<?php echo translatefields2(428);?>!");
												$('#calendar').fullCalendar('refetchEvents');
											}
										})
									}
								...
								if (html == "overlap"){
									...
									if (event.reservation_status !=5){
										...
										if (event.reservation_status == 1 || event.reservation_status == 4 || event.reservation_status ==5){
											...
											if (event.reservation_status == 1 || event.reservation_status == 4){
												alert("<?php echo translatefields2(717);?>");
											}
										}else{
											if (!confirm("<?php echo translatefields2(745);?>")) {
												$.ajax({
