...
<script type='text/javascript'>
	...
	$(document).ready(function() {
		...
		$('#calendar').fullCalendar({
			...
			?>
			minTime:'<?php echo $rowcal['min_time']?>:00',
			maxTime:'<?php echo $rowcal['max_time']?>:00',
			<?php
			}?>
...
<div class='external-event' title="<?php echo translatefields(732);?>" style="background-color:#eeeeee;border:1px solid #cccccc;color:black;font-color:black;font-size:12px;size:12px;"><?php echo translatefields(732);?>
		</div>
		<div class='external-event' title="<?php echo translatefields(733);?>" style="background-color:#eeeeee;border:1px solid #cccccc;color:black;font-color:black;font-size:12px;size:12px;"><?php echo translatefields(733);?>
		</div>
...
?>
	<form method="post" action="index.php?option=my-calendar-reservation" id="calendarform">
			...
			<br />
			<div style="border-top:1px solid #cccccc;padding-top:5px;padding-bottom:5px;"><center><b></b></center></div>
			<b><?php echo translatefields(739);?></b> <?php echo $req_fld; ?>&nbsp;
            <input type="text" name="min_time" id="min_time" style="width:25px;" maxlength="2" value="<?php echo $mintime;?>"/>
            <span class="validation-status"></span>
			<br />
			</div>
			<div>
			<b><?php echo translatefields(740);?></b> <?php echo $req_fld; ?>&nbsp;
            <input type="text" name="max_time" id="max_time" style="width:25px;" maxlength="2" value="<?php echo $maxtime;?>"/>
            <span class="validation-status"></span>
			<br />
			</div>
	...
	var validator = $("#calendarform").validate({
		...
		messages: {
			min_time:{required:"",number:""},
			max_time:{required:"",number:""}
		},
		errorPlacement: function(error, element) {
			if ( element.is(":radio") )
				error.appendTo( element.parent().next().next() );
