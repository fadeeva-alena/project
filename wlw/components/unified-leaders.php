	...
	?>
		...
		*/
		...
		if ($_GET['search_keyword'] != ""){
			...
			//$search_keyword = $_SESSION['events_searchkeyword1'];
		}
...
<?php
     ...
     {display: '<?php echo $contact;?>', name : '', width : 300, sortable : false, align: 'left'},
     ...
     return false;
     ...
     else if (com=='<?php echo $unifiededit;?>')
		{
			...
			if (numSelected > 1){
				...
				//alert(allVals);
				document.location.href='index.php?mode=view&option=unified-leaders-m&ids=' + allVals;
			}else{
