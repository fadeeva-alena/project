...
<div class="toggle">- <a style="font-weight:bold;font-size;13px;" href="javascript:toggleDiv('panel<?php echo $ctr;?>');" ><?php echo utf8_encode($title);?></a></div>



<div style="width:400px;display:none;margin-top:5px;" id="panel<?php echo $ctr;?>" class="panel">
		...
		<tr>
				...
				<tr>
                    ...
                    <td>
                        ...
                        <span class="validation-status"></span></td>
                    <?php } else { ?>
                    <td><?php echo utf8_encode($eve_contact_email)?></td>
                    <?php } ?>                                                                                                    
                </tr>
				...
				<tr>
                    ...
                    <td>
                        ...
                        <span class="validation-status"></span></td>
                    <?php } else { ?>
                    <td><?php echo utf8_encode($eve_contact_url)?></td>
                    <?php } ?>                                                                                                    
                </tr>
        ...
        <?php } ?>
				...
				<tr>
                    ...
                    <td><?php 
						...
						echo utf8_encode($rowp['firstname'] . " " . $rowp['lastname']);
					?></td>
                </tr>
