...
switch ($form_action)
{
	case 'ADD':	
		...
		header ("Location: display-event.php?events_id=".$_REQUEST['events_id']."&titlecolor=".$_REQUEST['titlecolor']."&bgcolor=".$_REQUEST['bgcolor']."&titlebgcolor=".$_REQUEST['titlebgcolor']."&tablegrid=".$_REQUEST['tablegrid']."");
		break;
...
<?php if ( $mode == 'delete' ) { ?>
	<div id="system-message">
		<form action="events-registration.php" method="post" name="frm_<?php echo $page_name; ?>">
		
		
		
		<input type="hidden" name="events_id" value="<?php echo $_REQUEST['events_id']; ?>">
...
<div class="content-main wide80" style="size:11px;font-size:11px;size:11px;font-size:11px;width:470px;">
    ...
    <form action="events-registration.php" method="post" id="frm_<?php echo $page_name; ?>" enctype="multipart/form-data">
	<input type="hidden" name="events_id" value="<?php echo $_REQUEST['events_id']; ?>">
		<input type="hidden" name="titlecolor" value="<?php echo $_REQUEST['titlecolor']; ?>">
		<input type="hidden" name="bgcolor" value="<?php echo $_REQUEST['bgcolor']; ?>">
		<input type="hidden" name="titlebgcolor" value="<?php echo $_REQUEST['titlebgcolor']; ?>">
