...
?>
  ...
  <div class="row">
    ...
    <div class=""><div style="position:relative;"><div id="handy1" style="position:absolute; top:-25px; left:0px; width:300px; color:#fff; display:none;">Die Angabe der Handynummer ist<br />notwendig. Falls Sie das Passwort<br />vergessen wir lhnen dieses per SMS zu.</div></div></div>
  </div>
  <div class="row">
