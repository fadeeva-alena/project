...
{
echo '<script language="javascript">confirm("Your municipality / town has unfortunately not licensed ManiMano. ManiMano can only be used if it is licensed by your municipality.")</script>';
...
{
echo '<script language="javascript">confirm("Thank you for your interest in ManiMano. At the moment, your home town / city has not yet activated ManiMano.
ManiMano can only be used if it is licensed from your municipality / city
")</script>';
...
echo "alert('The entered Password or Username is not correct, please check your entry.')";
echo "</script>" ;
...
require("include/SMS.inc");
     ...
     $sms->addRecipient("$num","555555");
      $sms->setContent("Your ManiMano Password is: $row[password]. Lots of fun wishes you the ManiMano Team.");
      $result = $sms->sendSMS();
      if ($result != 1) {
...
{
echo "<script language = 'javascript'>";
echo "alert('Enter your cellphone number with out the country code, e.g. (079 423 26 60)')";
echo "</script>" ;
...
require("include/SMS.inc");
      ...
      //$sms->addRecipient("$row[tel_m]","555555");
   $sms->addRecipient("$num","555555");
      $sms->setContent("Your ManiMano Username is:$row[username] ; Your ManiMano Password is: $row[password] . Lots of fun wishes you the ManiMano Team.");
      $result = $sms->sendSMS();
      if ($result != 1) {
        $error = $sms->getErrorDescription();
      }
