...
if($_POST["nextbtn"] == "Save and continue to Users Profile (4 of 6)"  )
{
$Nv=$_POST['Nv'];
...
<input type=button value="Legal" onclick=location.href="Rechtliches.php" id="helpbtn3">
	...
	<input type=button value="My Settings" onclick=location.href="settings2.php" id="maindatbtn">
	<?php
...
?>
  ...
  <div class="mainContent">
	<div class="content">
		<span id="title">3) Service Profile:  <img src="../images/page3.png" border="0"  usemap="#green" align="right" /></span>
<map name="green">
...
<area shape="rect" alt="" coords="135,2,149,30" href="javascript:Nav(6);">
  ...
  <form method="post"  name="form1" action="settings3.php">
		...
		<span style="line-height: 115%; font-family: Times New Roman; color: black; background: white">
		The creating of a service profile is optional.</span></span><span class="apple-converted-space"><span style="line-height: 115%; font-family: Times New Roman; color: black; background: white">&nbsp;</span></span><span class="apple-style-span"><span style="line-height: 115%; font-family: Times New Roman; color: black">If 
		you want to be found by someone who needs support, there is obviously no 
		way around it.</span></span><span class="apple-converted-space"><span style="line-height: 115%; font-family: Times New Roman; color: black">&nbsp;</span></span><span class="apple-style-span"><span style="line-height: 115%; font-family: Times New Roman; color: black; background: white">There 
		are 12 service types.</span></span><span class="apple-converted-space"><span style="line-height: 115%; font-family: Times New Roman; color: black; background: white">&nbsp;</span></span><span class="apple-style-span"><span style="line-height: 115%; font-family: Times New Roman; color: black">Click 
		on each one that applies to you and you enjoy doing - Blue is for 
		enabled - Red stands for non active.</span></span></p>
		<p id="maintext">&nbsp;</p>
	  <p>&nbsp;</p>
		<table width="900" border="0" cellspacing="10" cellpadding="0">
		  <tr>
		    <td width="200">
			<div id="lbltext2">
				<p class="MsoNormal">Repair work</div>
	...
	<input type="hidden" Name="hummer"  id="hummer" value="<?php echo"$hummer ";?>">	
		    ...
		    <td width="200">
			<div id="lbltext3">
				<p class="MsoNormal">Housework&nbsp;(Washing, ironing, cooking)</div>
          ...
          <input type="hidden" Name="haushalt"  id="haushalt" value="<?php echo"$haushalt ";?>">	
		    ...
		    <td width="200">
			<div id="lbltext2">
				<p class="MsoNormal">Tuition and Music lessons</div>
...
if($count==1){  
		  ...
		  <tr>
		    <td width="200">
			<div id="lbltext2">
				<p class="MsoNormal">Office work</div>
...
<input type="hidden" Name="office"  id="office" value="<?php echo"$office ";?>">	
		    ...
		    <td width="200">
			<div id="lbltext">
				<p class="MsoNormal">Child care</div>
...
?>
		    ...
		    <td width="200">
			<div id="lbltext2">
				<p class="MsoNormal">Seniors Support</div>
...
<input type="hidden" Name="shopping"  id="shopping" value="<?php echo"$shopping ";?>">
		  ...
		  <tr>
			...
			<div id="lbltext2"><span class="apple-style-span">
				...
				<span style="line-height: 115%; color: black">Gardenwork</span></font><font face="Times New Roman"><span style="line-height: 115%; color: black"> 
...
<input type="hidden" Name="garden"  id="garden" value="<?php echo"$garden ";?>">	
		    ...
		    <td width="200">
			<div id="lbltext">
				<p class="MsoNormal">Transportation</div>
...
<input type="hidden" Name="transport"  id="transport" value="<?php echo"$transport ";?>">	
		    ...
		    <td width="200">
			<div id="lbltext2">
				<p class="MsoNormal">Accompany, Listening, Being there</div>
...
<input type="hidden" Name="cleaning"  id="cleaning" value="<?php echo"$cleaning ";?>">	
		    ...
		    <td width="200">
			<div id="lbltext2">
				<p class="MsoNormal">Animal care</div>
...
<input type="hidden" Name="Nv"  id="Nv" value="<?php echo"$Nv";?>">
      <p><input type="submit" name="nextbtn" id="nextbtn" value="Save and continue to Users Profile (4 of 6)" onclick=location.href="settings4.php" /></p>
</form>
    </div>
  </div>
</div>
