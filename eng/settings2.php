...
if($_POST["nextbtn"] == "Save and continue to Services profile (3 of 6)" )
{
...
$intYear = $arrDate[2];
  if (strlen($intYear) < 4)
$errors .= "Bitte geben Sie Ihr Anfangs-Datum ein (z.B. 31.12.1970) / use dd.mm.yyyy";
...
$intYear = $arrDate[2];
 if (strlen($intYear) < 4)
$errors .= "Bitte geben Sie Ihr Enddatum ein (z.B. 31.12.1970) / use dd.mm.yyyy";
$intIsDate = checkdate($intMonth, $intDay, $intYear);    
 if(!$intIsDate)
     {
...
<input type=button value="Legal" onclick=location.href="Rechtliches.php" id="helpbtn3">
	...
	<input type=button value="My Setting" onclick=location.href="settings1.php?al=''" id="maindatbtn">
<?php
...
?>
  ...
  <div class="mainContent">
	<div class="content">
		<span id="title">2) Time Availability:  <img src="../images/page2.png" border="0"  usemap="#green" align="right" /></span>
<map name="green">
...
<input type="hidden" Name="Nv"  id="Nv" value="<?php echo"$Nv";?>">
	  <table width="800" border="0" cellspacing="0" cellpadding="0">
	    <tr>
	      <td width="435"><label id="smal">Active Time Availability:
	          <input name="" type="text" id="" size="29" value='<?php  $da1 =strtotime(date("d.m.Y")) ;
...
echo"Temporary Time Availability";
else
echo"Basic Time Availability"; ?>' />
	      </label>
            <div id="TabbedPanels1" class="TabbedPanels">
              <ul class="TabbedPanelsTabGroup">
                <li class="TabbedPanelsTab" tabindex="0">Basic Time Availability</li>
                <li class="TabbedPanelsTab" tabindex="0">Temporary Time Availability</li>
              </ul>
                ...
                <div class="TabbedPanelsContent">
                  ...
                  <table border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      ...
                      <td style="background:#56769d; color:#fff;"><input type='checkbox' name='Mo' onclick=javascript:Change("Mo")>Mon</td>

<td style="background:#56769d; color:#fff;"><input type='checkbox' name='Di' onclick=javascript:Change("Di")>Tue</td>
<td style="background:#56769d; color:#fff;"><input type='checkbox' name='Mi' onclick=javascript:Change("Mi")>Wed</td>
<td style="background:#56769d; color:#fff;"><input type='checkbox' name='Do' onclick=javascript:Change("Do")>Thu</td>
<td style="background:#56769d; color:#fff;"><input type='checkbox' name='Fr' onclick=javascript:Change("Fr")>Fri</td>
<td style="background:#56769d; color:#fff;"><input type='checkbox' name='Sa' onclick=javascript:Change("Sa")>Sat</td>
<td style="background:#56769d; color:#fff;"><input type='checkbox' name='So'onclick=javascript:Change("So")>Sun</td>
...
?>
                ...
                <div class="TabbedPanelsContent">
                  ...
                  <table border="0" cellpadding="0" cellspacing="0">
                    <tr>
                       <td style="background:#56769d; color:#fff;"></td>
                      <td style="background:#56769d; color:#fff;"><input type='checkbox' name='tMo' onclick=javascript:Change("tMo")>Mon</td>

<td style="background:#56769d; color:#fff;"><input type='checkbox' name='tDi' onclick=javascript:Change("tDi")>Tue</td>
<td style="background:#56769d; color:#fff;"><input type='checkbox' name='tMi' onclick=javascript:Change("tMi")>Wed</td>
<td style="background:#56769d; color:#fff;"><input type='checkbox' name='tDo' onclick=javascript:Change("tDo")>Thu</td>
<td style="background:#56769d; color:#fff;"><input type='checkbox' name='tFr' onclick=javascript:Change("tFr")>Fri</td>
<td style="background:#56769d; color:#fff;"><input type='checkbox' name='tSa' onclick=javascript:Change("tSa")>Sat</td>
<td style="background:#56769d; color:#fff;"><input type='checkbox' name='tSo' onclick=javascript:Change("tSo")>Sun</td>
...
?>
          ...
          You have to file a time availability profile  - You get up early - and prefer not to be disturbed at night. While others are the opposite. And for some, Sunday is the holy day.<br />
          Here you can choose when you want to be contacted.
          <br /><br />
          The temporary schedule is for example when you go on holiday. This way you have a second schedule so that you don’t have to make any changes to your prime schedule.
          <br /><br />
                    The temporary schedule has a period of validity. When the end date is reached, the system automatically reactivates the basic schedule. <br />
          The basic schedule should be put on hold while the temporary schedule is active.<br />
          When you click the row and column tab, you can flip an
entire column / row. So it works very fast.
      ...
      <p><input type="submit" name="nextbtn" id="nextbtn" value="Save and continue to Services profile (3 of 6)" onclick=location.href="settings3.php" /></p>
</form>
	</div>
  </div>
</div>
...
<!--
var TabbedPanels1 = new Spry.Widget.TabbedPanels("TabbedPanels1",{ defaultTab: <?php  $da1 =strtotime(date("d.m.Y")) ;
