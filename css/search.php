...
?>
				...
				<p>Suchen Sie Arbeit oder Unterstützung?<br />Hier konnen Sie das auswahlen - hier müssen Sie sich festlegen.</p>
                ...
                Ich suche Unterstutzung/bezahle dafur</label> <br /><label>
					<input type="radio" name="RadioGroup1" value="2" id="RadioGroup1_1" /<?PHP print $type1_status; ?>>
                Ich biete Unterstutzung/mochte etwas verdienen</label> <br />
					</p>
				</form></div></li>
			<li>
<?php
...
//$quer3=mysql_query("SELECT image_path FROM t_skill_types where skill_type_id=$kinder") or die (mysql_error()); 
			echo "<div>";
				...
				echo "<p>Hier konnen Sie die gewünschte Kategorie auswahlen:<br />Diese Felder müssen ausgewahlt werden</p>";
...
?>
				<p>In gewissen Fallen ist die Wahl des Geschlechts von Bedeutung.<br />Hier konnen Sie festlegen, was wir finden - diese Wahl ist optional.</p>
			...
			<div><div id="li4">Gesucht wird immer in ihrem<br />
			        naheren Umfeld (ca. 5min/500m).<br />
			        Drücken Sie SUCHE um zu starten.</div><input type="button" name="button" id="searchbtn" value="Suchen" onclick=javascript:passv() >
			</div></li>
		</ol>
    </div>
  </div>
