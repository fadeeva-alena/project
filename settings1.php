...
<SPAN id='PopUpText'>TEXT</SPAN>
    ...
    <div class='row'>
      ...
      <div class='col-md-1'>Geb.-Datum:</div>
    ...
    <div class='row'>
      ...
      <div class='col-md-3'>
        <input type="image" name="Bild" id="Bild" src=<?php echo"'images/profile/{$row['image_path']}'";?> style="float:left; margin-right:10px;" onMouseOver="showPos(event,'Wenn man Sie noch nicht kennt, fasst man viel leichter Vertrauen zu Ihnen, wenn Sie hier ein schönes Bild hinterlegen - und man erkennt Sie wieder, auch wenn man Ihren Namen nicht kennt (Pflicht).','Bild')" onMouseOut="document.getElementById('Popup').style.display='none'" />
    ...
    <div class='row'>
      ...
      <div class='col-md-3'><input type="text" name="handy" id="handy" Value="<?php echo"$row[tel_m]"; ?>" onFocus="showPos(event,'Die Angabe der Handynummer ist<br />notwendig. Falls Sie das Passwort<br />vergessen, senden wir lhnen dieses per SMS zu.','handy')" onBlur="document.getElementById('PopUp').style.display='none'" />&nbsp;<span class="star"></span></div>
    ...
    <div class='row'>
      ...
      <div class='col-md-3'>
        <select name='vorzugs' id='vorzugs' onFocus="showPos(event,'Hier können sie angeben, wie sie am <br />Liebsten erreicht werden können','vorzugs')" onBlur="document.getElementById('PopUp').style.display='none'">
    ...
    <div class='row'>
      ...
      <div class='col-md-3'><input type="text" name="stundenlohn" id="stundenlohn" size="11" Value="<?php echo"$row[price_per_hour]"; ?>" onFocus="showPos(event,'Hier können Sie lhren gewünschten <br />Stundenlohn eingeben. Wir schlagen 19.-/<br />Stunde für unqualifizierte Arbeiten vor<br />(ohne entsp. Ausbildung).','stundenlohn')" onBlur="document.getElementById('PopUp').style.display='none'" /> Fr.</div>
    ...
    <div class='row'>
		...
		<div class='col-md-3'>
			<textarea name="bemerkung" cols="45" id="bemerkung" onFocus="showPos(event,'Die Bemerkung, welche Sie hier eingeben <br />wird bei in der Trefferliste mitangezeigt. <br />Ideal z.B. für Einschränkungen oder <br />zusätzliche Angaben / Qualifizierungen.','bemerkung')" onBlur="document.getElementById('PopUp').style.display='none'" ><?php echo"$row[note]";?></textarea>
		</div>
		<div class='col-md-3'>
			<div style="position:relative;">
    ...
    <div class='row'>
		<div class='col-md-12'>
			...
			<input type="submit" name="submit" id="nextbtn" class="form-control btn btn-primary" value="Speichern und weiter zur zeitlichen Verfügbarkeit (2 von 6)" />
		</div>
    </div>
