...
$newimage = "http://manimano.ch/images/profile/" . $imagename;
...
// $handle->image_ratio_y        = true;
 // $handle->process('http://manimano.ch/images/profile/');
  //if ($handle->processed) {
    //    echo 'image resized';
     //    $handle->clean();
//$k=$imagename;
...
$im = "http://manimano.ch/images/profile/" . $imgn ;
}
...
//$k=$_GET['im'];
//if($k <>"") 
//$im = "http://manimano.ch/images/profile/" . $k ;
//else
//$im = "http://manimano.ch/images/profile/no_picture_he.gif";
if($j<>"")
{
...
var k = 0;
 if (imgSource == 'http://manimano.ch/http://manimano.ch/images/profile/no_picture_he.jpg')
k = 1;
 if (imgSource == 'http://manimano.ch/http://manimano.ch/images/profile/no_picture_she.jpg')
k = 1;
 if (imgSource == 'http://www.manimano.ch/http://manimano.ch/images/profile/no_picture_he.jpg')
k = 1;
 if (imgSource == 'http://www.manimano.ch/http://manimano.ch/images/profile/no_picture_she.jpg')
k = 1;
if (k == 1)
{
if (strUser== 'männlich')
...
document.getElementById('Bild').src="http://manimano.ch/images/profile/no_picture_he.jpg"  ;

  
  document.getElementById('imgn').value="http://manimano.ch/images/profile/no_picture_he.jpg"  ;
...
if (strUser== 'weiblich')
{
document.getElementById('Bild').src="http://manimano.ch/images/profile/no_picture_she.jpg" ;

document.getElementById('imgn').value="http://manimano.ch/images/profile/no_picture_she.jpg"  ;
...
// $handle->image_ratio_y        = true;
  $handle->process('http://manimano.ch/images/profile/temp/');
 if ($handle->processed) {
...
rename("http://manimano.ch/images/profile/temp/".$imgn , "http://manimano.ch/images/profile/".$imgn);
// End Change
...
$image_y             = 84;
	  if( $gen== 1)
	  $im = "http://manimano.ch/images/profile/no_picture_she.jpg" ;
	  else
	  $im = "http://manimano.ch/images/profile/no_picture_he.jpg" ;
}
...
?>
  ...
  <tr>
    ...
    <td><div style="position:relative;"><div id="pass" style="position:absolute; top:-30px; left:0px; width:300px; color:#fff; display:none;">Sie können einen Benutzernamen wählen. <br />Wir prüfen, ob er noch frei ist. <br />Wir schlagen Vorname. Nachname. Ort vor, <br />z.B. David.Schlaepfer.Egg</div></div></td>
  </tr>
  <tr>
    <td>Stundenlohn:</td>
    <td colspan="3"><input type="text" name="stundenlohn" id="stundenlohn" size="11" value="<?php echo"$stundenlohn ";?>" onFocus="document.getElementById('student').style.display='block'" onBlur="document.getElementById('student').style.display='none'" tabindex="19"> Fr.</td>
    <td><div style="position:relative;"><div id="student" style="position:absolute; top:-30px; left:0px; width:300px; color:#fff; display:none;">Hier können Sie lhren gewünschten <br />Stundenlohn eingeben. Wir schlagen 19.-/<br />Stunde für unqualifizierte Arbeiten vor<br />(ohne entsp. Ausbildung).</div></div></td>
  </tr>
  <tr>
    ...
    <td><div style="position:relative;"><div id="bemerkung1" onKeyDown="" style="position:absolute; top:-30px; left:0px; width:300px; color:#fff; display:none;">Die Bemerkung, welche Sie hier eingeben <br />wird bei in der Trefferliste mitangezeigt. <br />Ideal z.B. für Einschränkungen oder <br />zusätzliche Angaben / Qualifizierungen.</div></div></td>
  </tr>
  <tr>
    <td><input type="hidden" name="order" id="order" size="26" value="<?php echo"$order";?>">

</td>
    <td colspan="4"><input  tabindex="20" type="submit" name="nextbtn" id="nextbtn" value="Speichern und weiter zur zeitlichen Verfügbarkeit (2 von 6)"  /></td>
  </tr>
</table>
 </form>
<?php
