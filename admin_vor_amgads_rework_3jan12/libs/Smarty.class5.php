...
/* $Id: Smarty.class5.php,v 1.3 2008/02/06 15:13:53 Administrator Exp $ */
 ...
 */
    ...
    function Smarty()
    {
	  ...
	  $this->compile_dir = $path.$this->compile_dir;
    ...
    function &get_template_vars($name=null)
    {
        if(!isset($name)) {
            ...
            // public non-existant, return valid reference
            $_tmp = null;
            return $_tmp;   
        }
    }
    ...
    function fetch($resource_name, $cache_id = null, $compile_id = null, $display = false)
    {
        ...
        $_smarty_old_error_level = $this->debugging ? error_reporting() : error_reporting(isset($this->error_reporting)
               ? $this->error_reporting : error_reporting() & ~ (E_NOTICE | E_STRICT));
     ...
     * @param string $public
     */
    function clear_config($public = null)
    {
        if(!isset($public)) {
            // clear all values
            ...
            unset($this->_config[0]['vars'][$public]);
        }
    }
