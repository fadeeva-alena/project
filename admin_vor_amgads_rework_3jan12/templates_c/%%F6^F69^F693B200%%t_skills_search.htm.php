<?php /* Smarty version 2.6.13, created on 2011-07-20 04:57:35
         compiled from t_skills_search.htm */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'include_if_exists', 't_skills_search.htm', 8, false),array('function', 'doevent', 't_skills_search.htm', 15, false),array('function', 'build_edit_control', 't_skills_search.htm', 51, false),)), $this); ?>
<html>
<head>
<title>t_skills: Advanced search page</title>
</head>
...
<td width=200 class=tableheader>t_skills</td>
...
<tr class=shade>
	<td class=editshade_b>skill_id
	<input type="Hidden" name="asearchfield[]" value="skill_id"></td>
	<td align=center class=editshade_lb><input type=CheckBox name="not_skill_id" <?php echo $this->_tpl_vars['not_skill_id']; ?>
></td>
	
	<td class=editshade_lb>
	<?php echo $this->_tpl_vars['searchtype_skill_id']; ?>

	</td>
	
	<td width=270 class=editshade_lb><?php echo smarty_function_build_edit_control(array('field' => 'skill_id','value' => $this->_tpl_vars['value_skill_id'],'mode' => 'search'), $this);?>
</td>

	<td width=270 class=editshade_lb><span id="second_skill_id">
	<?php echo smarty_function_build_edit_control(array('field' => 'skill_id','second' => true,'value' => $this->_tpl_vars['value1_skill_id'],'mode' => 'search'), $this);?>
...
<tr class=shade>
	<td class=editshade_b>skill_type_id
	<input type="Hidden" name="asearchfield[]" value="skill_type_id"></td>
	<td align=center class=editshade_lb><input type=CheckBox name="not_skill_type_id" <?php echo $this->_tpl_vars['not_skill_type_id']; ?>
></td>
	
	<td class=editshade_lb>
	<?php echo $this->_tpl_vars['searchtype_skill_type_id']; ?>

	</td>
	
	<td width=270 class=editshade_lb><?php echo smarty_function_build_edit_control(array('field' => 'skill_type_id','value' => $this->_tpl_vars['value_skill_type_id'],'mode' => 'search'), $this);?>
</td>

	<td width=270 class=editshade_lb><span id="second_skill_type_id">
	<?php echo smarty_function_build_edit_control(array('field' => 'skill_type_id','second' => true,'value' => $this->_tpl_vars['value1_skill_type_id'],'mode' => 'search'), $this);?>
...
<tr class=shade>
	<td class=editshade_b>skill_subtype_id
	<input type="Hidden" name="asearchfield[]" value="skill_subtype_id"></td>
	<td align=center class=editshade_lb><input type=CheckBox name="not_skill_subtype_id" <?php echo $this->_tpl_vars['not_skill_subtype_id']; ?>
></td>
	
	<td class=editshade_lb>
	<?php echo $this->_tpl_vars['searchtype_skill_subtype_id']; ?>

	</td>
	
	<td width=270 class=editshade_lb><?php echo smarty_function_build_edit_control(array('field' => 'skill_subtype_id','value' => $this->_tpl_vars['value_skill_subtype_id'],'mode' => 'search'), $this);?>
</td>

	<td width=270 class=editshade_lb><span id="second_skill_subtype_id">
	<?php echo smarty_function_build_edit_control(array('field' => 'skill_subtype_id','second' => true,'value' => $this->_tpl_vars['value1_skill_subtype_id'],'mode' => 'search'), $this);?>
...
<tr class=shade>
	<td class=editshade_b>skill_note
	<input type="Hidden" name="asearchfield[]" value="skill_note"></td>
	<td align=center class=editshade_lb><input type=CheckBox name="not_skill_note" <?php echo $this->_tpl_vars['not_skill_note']; ?>
></td>
	
	<td class=editshade_lb>
	<?php echo $this->_tpl_vars['searchtype_skill_note']; ?>

	</td>
	
	<td width=270 class=editshade_lb><?php echo smarty_function_build_edit_control(array('field' => 'skill_note','value' => $this->_tpl_vars['value_skill_note'],'mode' => 'search'), $this);?>
</td>

	<td width=270 class=editshade_lb><span id="second_skill_note">
	<?php echo smarty_function_build_edit_control(array('field' => 'skill_note','second' => true,'value' => $this->_tpl_vars['value1_skill_note'],'mode' => 'search'), $this);?>
...
<tr class=shade>
	<td class=editshade_b>skill_hourly
	<input type="Hidden" name="asearchfield[]" value="skill_hourly"></td>
	<td align=center class=editshade_lb><input type=CheckBox name="not_skill_hourly" <?php echo $this->_tpl_vars['not_skill_hourly']; ?>
></td>
	
	<td class=editshade_lb>
	<?php echo $this->_tpl_vars['searchtype_skill_hourly']; ?>

	</td>
	
	<td width=270 class=editshade_lb><?php echo smarty_function_build_edit_control(array('field' => 'skill_hourly','value' => $this->_tpl_vars['value_skill_hourly'],'mode' => 'search'), $this);?>
</td>

	<td width=270 class=editshade_lb><span id="second_skill_hourly">
	<?php echo smarty_function_build_edit_control(array('field' => 'skill_hourly','second' => true,'value' => $this->_tpl_vars['value1_skill_hourly'],'mode' => 'search'), $this);?>
