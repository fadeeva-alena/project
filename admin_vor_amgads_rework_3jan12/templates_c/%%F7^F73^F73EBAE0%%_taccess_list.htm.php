<?php /* Smarty version 2.6.13, created on 2011-07-20 04:59:19
         compiled from _taccess_list.htm */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'include_if_exists', '_taccess_list.htm', 9, false),array('function', 'doevent', '_taccess_list.htm', 503, false),)), $this); ?>
<html>
<head>
<title>taccess</title>
...
<form name="frmSearch" method="GET" action="_taccess_list.php">
...
&nbsp;&nbsp;&nbsp;
<a href="_taccess_search.php">Advanced search</a>	
...
<option value="Country" <?php echo $this->_tpl_vars['search_Country']; ?>
>Country</option>
<option value="Zip" <?php echo $this->_tpl_vars['search_Zip']; ?>
>Zip</option>
<option value="Location" <?php echo $this->_tpl_vars['search_Location']; ?>
>Location</option>
<option value="Start" <?php echo $this->_tpl_vars['search_Start']; ?>
>Start</option>
<option value="End" <?php echo $this->_tpl_vars['search_End']; ?>
>End</option>
...
&nbsp;&nbsp;&nbsp;Records Per Page:
<select 
onChange="javascript: document.location='_taccess_list.php?pagesize='+this.options[this.selectedIndex].value;">
...
<span style="white-space:nowrap;">
 ...
 <!-- Add new record -->
<span class=buttonborder><input class=button type=button value="Add new" onclick="window.location.href='_taccess_add.php'"></span>
...
<span class=buttonborder><input class=button type=button value="Delete selected" onClick="if (confirm('Do you really want to delete these records?')) frmAdmin.submit(); return false;"></span>
...
<!-- delete form -->
<form method="POST" action="_taccess_list.php" name="frmAdmin">
...
<a class="tablelinks" 
href="_taccess_list.php?orderby=<?php echo $this->_tpl_vars['order_dir_Country']; ?>
Country">
Country</a>
</td>
<td><?php echo $this->_tpl_vars['order_image_Country']; ?>
</td>
</table>
</td>
<td class="headerlist"><table cellpadding=0 cellspacing=0 border=0 align=center><tr><td>
<a class="tablelinks" 
href="_taccess_list.php?orderby=<?php echo $this->_tpl_vars['order_dir_Zip']; ?>
Zip">
Zip</a>
</td>
...
<td class="headerlist"><table cellpadding=0 cellspacing=0 border=0 align=center><tr><td>
<a class="tablelinks" 
href="_taccess_list.php?orderby=<?php echo $this->_tpl_vars['order_dir_Location']; ?>
Location">
Location</a>
</td>
...
<td class="headerlist"><table cellpadding=0 cellspacing=0 border=0 align=center><tr><td>
<a class="tablelinks" 
href="_taccess_list.php?orderby=<?php echo $this->_tpl_vars['order_dir_Start']; ?>
Start">
Start</a>
</td>
<td><?php echo $this->_tpl_vars['order_image_Start']; ?>
</td>
</table>
</td>
<td class="headerlist"><table cellpadding=0 cellspacing=0 border=0 align=center><tr><td>
<a class="tablelinks" 
href="_taccess_list.php?orderby=<?php echo $this->_tpl_vars['order_dir_End']; ?>
End">
End</a>
</td>
<td><?php echo $this->_tpl_vars['order_image_End']; ?>
</td>
</table>
</td>
<td class="headerlist"><table cellpadding=0 cellspacing=0 border=0 align=center><tr><td>
<a class="tablelinks" 
href="_taccess_list.php?orderby=<?php echo $this->_tpl_vars['order_dir_Note']; ?>
Note">
Note</a>
</td>
...
<a class="tablelinks" 
href="_taccess_list.php?orderby=<?php echo $this->_tpl_vars['order_dir_ID']; ?>
ID">
ID</a>
</td>
...
<a class="tablelinks" href="_taccess_edit.php?" id="editlink_add" >
Edit</a>
</td>
...
<td align="center" valign=middle class=borderbody>
<a class="tablelinks" href="_taccess_edit.php?" id="ieditlink_add">
Inline Edit</a>
</td>
...
<td align="center" valign=middle class=borderbody>
<a class="tablelinks" href="_taccess_view.php?" id="viewlink_add">
View</a>
</td>
...
<span id="add_Country"></span>&nbsp;
</td>
<td valign=middle class=borderbody>
<span id="add_Zip"></span>&nbsp;
</td>
<td valign=middle class=borderbody>
<span id="add_Location"></span>&nbsp;
</td>
<td valign=middle class=borderbody>
<span id="add_Start"></span>&nbsp;
</td>
<td valign=middle class=borderbody>
<span id="add_End"></span>&nbsp;
</td>
<td valign=middle class=borderbody>
...
<a class="tablelinks" href="_taccess_edit.php?<?php echo $this->_tpl_vars['row']['1editlink']; ?>
...
<td align="center" valign=middle class=borderbody>
<a class="tablelinks" href="_taccess_view.php?<?php echo $this->_tpl_vars['row']['1editlink']; ?>
...
<td align=center valign=middle class=borderbody <?php echo $this->_tpl_vars['row']['1Country_style']; ?>
>
<?php echo $this->_tpl_vars['row']['1Country_value']; ?>
...
<td align=center valign=middle class=borderbody <?php echo $this->_tpl_vars['row']['1Start_style']; ?>
>
<?php echo $this->_tpl_vars['row']['1Start_value']; ?>

</td>
<td align=center valign=middle class=borderbody <?php echo $this->_tpl_vars['row']['1End_style']; ?>
>
<?php echo $this->_tpl_vars['row']['1End_value']; ?>
