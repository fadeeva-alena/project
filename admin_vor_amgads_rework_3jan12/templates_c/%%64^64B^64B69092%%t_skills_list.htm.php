<?php /* Smarty version 2.6.13, created on 2011-07-20 04:46:24
         compiled from t_skills_list.htm */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'include_if_exists', 't_skills_list.htm', 9, false),array('function', 'doevent', 't_skills_list.htm', 562, false),)), $this); ?>
<html>
<head>
...
<form name="frmSearch" method="GET" action="t_skills_list.php">
...
&nbsp;&nbsp;&nbsp;
<a href="t_skills_search.php">Advanced search</a>	
...
&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;
<a target="_blank" href="t_skills_export.php">Export results</a>



&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;
<a target="_blank" href="t_skills_print.php">Printer-friendly version</a>
&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;
<a target="_blank" href="t_skills_print.php?all=1">Print all pages</a>
...
&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;
<a href="t_skills_import.php">Import</a>
...
<option value="skill_id" <?php echo $this->_tpl_vars['search_skill_id']; ?>
>skill_id</option>
<option value="people_id" <?php echo $this->_tpl_vars['search_people_id']; ?>
>people_id</option>
<option value="skill_type_id" <?php echo $this->_tpl_vars['search_skill_type_id']; ?>
>skill_type_id</option>
<option value="skill_subtype_id" <?php echo $this->_tpl_vars['search_skill_subtype_id']; ?>
>skill_subtype_id</option>
<option value="skill_note" <?php echo $this->_tpl_vars['search_skill_note']; ?>
>skill_note</option>
<option value="skill_hourly" <?php echo $this->_tpl_vars['search_skill_hourly']; ?>
>skill_hourly</option>
...
&nbsp;&nbsp;&nbsp;Records Per Page:
<select 
onChange="javascript: document.location='t_skills_list.php?pagesize='+this.options[this.selectedIndex].value;">
...
<span class=buttonborder><input class=button type=button value="Export selected" onclick="var c=0; if(frmAdmin.elements['selection[]'].length==undefined && frmAdmin.elements['selection[]'].checked) c=1; else for (i=0;i<frmAdmin.elements['selection[]'].length;++i) if (frmAdmin.elements['selection[]'][i].checked) c=1;  if(c==0) return true; frmAdmin.action='t_skills_export.php';frmAdmin.target='_blank';frmAdmin.submit(); frmAdmin.action='t_skills_list.php'; frmAdmin.target='_self';"></span>



<span class=buttonborder><input class=button type=button value="Print selected" onclick="var c=0; if(frmAdmin.elements['selection[]'].length==undefined && frmAdmin.elements['selection[]'].checked) c=1; else for (i=0;i<frmAdmin.elements['selection[]'].length;++i) if (frmAdmin.elements['selection[]'][i].checked) c=1;  if(c==0) return true; frmAdmin.action='t_skills_print.php';frmAdmin.target='_blank';frmAdmin.submit(); frmAdmin.action='t_skills_list.php'; frmAdmin.target='_self';"></span>
...
<!-- delete form -->
<form method="POST" action="t_skills_list.php" name="frmAdmin">
...
<a class="tablelinks" 
href="t_skills_list.php?orderby=<?php echo $this->_tpl_vars['order_dir_skill_id']; ?>
skill%5Fid">
skill_id</a>
</td>
<td><?php echo $this->_tpl_vars['order_image_skill_id']; ?>
</td>
</table>
</td>
<td class="headerlist"><table cellpadding=0 cellspacing=0 border=0 align=center><tr><td>
<a class="tablelinks" 
href="t_skills_list.php?orderby=<?php echo $this->_tpl_vars['order_dir_people_id']; ?>
people%5Fid">
people_id</a>
</td>
...
<td class="headerlist"><table cellpadding=0 cellspacing=0 border=0 align=center><tr><td>
<a class="tablelinks" 
href="t_skills_list.php?orderby=<?php echo $this->_tpl_vars['order_dir_skill_type_id']; ?>
skill%5Ftype%5Fid">
skill_type_id</a>
</td>
<td><?php echo $this->_tpl_vars['order_image_skill_type_id']; ?>
</td>
</table>
</td>
<td class="headerlist"><table cellpadding=0 cellspacing=0 border=0 align=center><tr><td>
<a class="tablelinks" 
href="t_skills_list.php?orderby=<?php echo $this->_tpl_vars['order_dir_skill_subtype_id']; ?>
skill%5Fsubtype%5Fid">
skill_subtype_id</a>
</td>
<td><?php echo $this->_tpl_vars['order_image_skill_subtype_id']; ?>
</td>
</table>
</td>
<td class="headerlist"><table cellpadding=0 cellspacing=0 border=0 align=center><tr><td>
<a class="tablelinks" 
href="t_skills_list.php?orderby=<?php echo $this->_tpl_vars['order_dir_skill_note']; ?>
skill%5Fnote">
skill_note</a>
</td>
<td><?php echo $this->_tpl_vars['order_image_skill_note']; ?>
</td>
</table>
</td>
<td class="headerlist"><table cellpadding=0 cellspacing=0 border=0 align=center><tr><td>
<a class="tablelinks" 
href="t_skills_list.php?orderby=<?php echo $this->_tpl_vars['order_dir_skill_hourly']; ?>
skill%5Fhourly">
skill_hourly</a>
</td>
<td><?php echo $this->_tpl_vars['order_image_skill_hourly']; ?>
</td>
</table>
</td>
<td class="headerlist"><table cellpadding=0 cellspacing=0 border=0 align=center><tr><td>
<a class="tablelinks" 
href="t_skills_list.php?orderby=<?php echo $this->_tpl_vars['order_dir_prof_provider']; ?>
prof%5Fprovider">
prof_provider</a>
</td>
...
<td class="headerlist"><table cellpadding=0 cellspacing=0 border=0 align=center><tr><td>
<a class="tablelinks" 
href="t_skills_list.php?orderby=<?php echo $this->_tpl_vars['order_dir_firstname']; ?>
firstname">
firstname</a>
</td>
...
<td class="headerlist"><table cellpadding=0 cellspacing=0 border=0 align=center><tr><td>
<a class="tablelinks" 
href="t_skills_list.php?orderby=<?php echo $this->_tpl_vars['order_dir_lastname']; ?>
lastname">
lastname</a>
</td>
...
<td class="headerlist"><table cellpadding=0 cellspacing=0 border=0 align=center><tr><td>
<a class="tablelinks" 
href="t_skills_list.php?orderby=<?php echo $this->_tpl_vars['order_dir_image_path']; ?>
image%5Fpath">
image_path</a>
</td>
...
<td class="headerlist"><table cellpadding=0 cellspacing=0 border=0 align=center><tr><td>
<a class="tablelinks" 
href="t_skills_list.php?orderby=<?php echo $this->_tpl_vars['order_dir_street']; ?>
street">
street</a>
</td>
...
<td class="headerlist"><table cellpadding=0 cellspacing=0 border=0 align=center><tr><td>
<a class="tablelinks" 
href="t_skills_list.php?orderby=<?php echo $this->_tpl_vars['order_dir_house_nr']; ?>
house%5Fnr">
house_nr</a>
</td>
...
<td class="headerlist"><table cellpadding=0 cellspacing=0 border=0 align=center><tr><td>
<a class="tablelinks" 
href="t_skills_list.php?orderby=<?php echo $this->_tpl_vars['order_dir_zip']; ?>
zip">
zip</a>
</td>
...
<td class="headerlist"><table cellpadding=0 cellspacing=0 border=0 align=center><tr><td>
<a class="tablelinks" 
href="t_skills_list.php?orderby=<?php echo $this->_tpl_vars['order_dir_location']; ?>
location">
location</a>
</td>
...
<td class="headerlist"><table cellpadding=0 cellspacing=0 border=0 align=center><tr><td>
<a class="tablelinks" 
href="t_skills_list.php?orderby=<?php echo $this->_tpl_vars['order_dir_locationarea']; ?>
locationarea">
locationarea</a>
</td>
...
<td class="headerlist"><table cellpadding=0 cellspacing=0 border=0 align=center><tr><td>
<a class="tablelinks" 
href="t_skills_list.php?orderby=<?php echo $this->_tpl_vars['order_dir_tel_p']; ?>
tel%5Fp">
tel_p</a>
</td>
...
<td class="headerlist"><table cellpadding=0 cellspacing=0 border=0 align=center><tr><td>
<a class="tablelinks" 
href="t_skills_list.php?orderby=<?php echo $this->_tpl_vars['order_dir_tel_m']; ?>
tel%5Fm">
tel_m</a>
</td>
...
<a class="tablelinks" 
href="t_skills_list.php?orderby=<?php echo $this->_tpl_vars['order_dir_email']; ?>
email">
email</a>
</td>
...
<a class="tablelinks" href="t_skills_view.php?<?php echo $this->_tpl_vars['row']['1editlink']; ?>
" >
View</a>
</td>
...
<td align=center valign=middle class=borderbody <?php echo $this->_tpl_vars['row']['1skill_id_style']; ?>
>
<?php echo $this->_tpl_vars['row']['1skill_id_value']; ?>
...
<td align=center valign=middle class=borderbody <?php echo $this->_tpl_vars['row']['1skill_type_id_style']; ?>
>
<?php echo $this->_tpl_vars['row']['1skill_type_id_value']; ?>

</td>
<td align=center valign=middle class=borderbody <?php echo $this->_tpl_vars['row']['1skill_subtype_id_style']; ?>
>
<?php echo $this->_tpl_vars['row']['1skill_subtype_id_value']; ?>

</td>
<td align=center valign=middle class=borderbody <?php echo $this->_tpl_vars['row']['1skill_note_style']; ?>
>
<?php echo $this->_tpl_vars['row']['1skill_note_value']; ?>

</td>
<td align=center valign=middle class=borderbody <?php echo $this->_tpl_vars['row']['1skill_hourly_style']; ?>
>
<?php echo $this->_tpl_vars['row']['1skill_hourly_value']; ?>
