...
{
	$keys=array();
	$keys["skill_id"]=postvalue("editid1");
...
while($data)
{
	...
	$smarty->assign("show_key1", htmlspecialchars(GetData($data,"skill_id", "")));
...
//	skill_id - 
	$value="";
		$value = ProcessLargeText(GetData($data,"skill_id", ""),"","",MODE_VIEW);
	$smarty->assign("show_skill_id",$value);
////////////////////////////////////////////
//	people_id - 
	$value="";
...
//	skill_type_id - 
	$value="";
		$value=DisplayLookupWizard("skill_type_id",$data["skill_type_id"],$data,$keylink,MODE_VIEW);
			
	$smarty->assign("show_skill_type_id",$value);
////////////////////////////////////////////
//	skill_subtype_id - 
	$value="";
		$value=DisplayLookupWizard("skill_subtype_id",$data["skill_subtype_id"],$data,$keylink,MODE_VIEW);
			
	$smarty->assign("show_skill_subtype_id",$value);
////////////////////////////////////////////
//	skill_note - 
	$value="";
		$value = ProcessLargeText(GetData($data,"skill_note", ""),"","",MODE_VIEW);
	$smarty->assign("show_skill_note",$value);
////////////////////////////////////////////
//	skill_hourly - 
	$value="";
		$value = ProcessLargeText(GetData($data,"skill_hourly", ""),"","",MODE_VIEW);
	$smarty->assign("show_skill_hourly",$value);
////////////////////////////////////////////
//	prof_provider - 
	$value="";
...
$templatefile = "t_skills_view.htm";
