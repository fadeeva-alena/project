...
{
	document.getElementById('second_skill_id').style.display =  
		document.forms.editform.elements['asearchopt_skill_id'].value==\"Between\" ? '' : 'none'; 
	...
	document.getElementById('second_skill_type_id').style.display =  
		document.forms.editform.elements['asearchopt_skill_type_id'].value==\"Between\" ? '' : 'none'; 
	document.getElementById('second_skill_subtype_id').style.display =  
		document.forms.editform.elements['asearchopt_skill_subtype_id'].value==\"Between\" ? '' : 'none'; 
	document.getElementById('second_skill_note').style.display =  
		document.forms.editform.elements['asearchopt_skill_note'].value==\"Between\" ? '' : 'none'; 
	document.getElementById('second_skill_hourly').style.display =  
		document.forms.editform.elements['asearchopt_skill_hourly'].value==\"Between\" ? '' : 'none'; 
...
$(document).ready(function() {
	document.forms.editform.value_skill_id.onkeyup=function(event) {searchSuggest(event,document.forms.editform.value_skill_id,'advanced')};
	document.forms.editform.value1_skill_id.onkeyup=function(event) {searchSuggest(event,document.forms.editform.value1_skill_id,'advanced1')};
	document.forms.editform.value_skill_id.onkeydown=function(event) {return listenEvent(event,document.forms.editform.value_skill_id,'advanced')};
	document.forms.editform.value1_skill_id.onkeydown=function(event) {return listenEvent(event,document.forms.editform.value1_skill_id,'advanced1')};
	...
	document.forms.editform.value_skill_hourly.onkeyup=function(event) {searchSuggest(event,document.forms.editform.value_skill_hourly,'advanced')};
	document.forms.editform.value1_skill_hourly.onkeyup=function(event) {searchSuggest(event,document.forms.editform.value1_skill_hourly,'advanced1')};
	document.forms.editform.value_skill_hourly.onkeydown=function(event) {return listenEvent(event,document.forms.editform.value_skill_hourly,'advanced')};
	document.forms.editform.value1_skill_hourly.onkeydown=function(event) {return listenEvent(event,document.forms.editform.value1_skill_hourly,'advanced1')};
...
{
	$opt=@$_SESSION[$strTableName."_asearchopt"]["skill_id"];
	$not=@$_SESSION[$strTableName."_asearchnot"]["skill_id"];
	$smarty->assign("value_skill_id",@$_SESSION[$strTableName."_asearchfor"]["skill_id"]);
	$smarty->assign("value1_skill_id",@$_SESSION[$strTableName."_asearchfor2"]["skill_id"]);
}	
if($not)
	$smarty->assign("not_skill_id"," checked");
...
$searchtype = "<SELECT ID=\"SearchOption\" NAME=\"asearchopt_skill_id\" SIZE=1 onChange=\"return ShowHideControls();\">";
$searchtype .= $options;
$searchtype .= "</SELECT>";
$smarty->assign("searchtype_skill_id",$searchtype);
//	edit format
$editformats["skill_id"]="Text field";
// people_id 
$opt="";
$not=false;
if(@$_SESSION[$strTableName."_search"]==2)
...
if(@$_SESSION[$strTableName."_search"]==2)
{
	$opt=@$_SESSION[$strTableName."_asearchopt"]["skill_type_id"];
	$not=@$_SESSION[$strTableName."_asearchnot"]["skill_type_id"];
	$smarty->assign("value_skill_type_id",@$_SESSION[$strTableName."_asearchfor"]["skill_type_id"]);
	$smarty->assign("value1_skill_type_id",@$_SESSION[$strTableName."_asearchfor2"]["skill_type_id"]);
}	
if($not)
	$smarty->assign("not_skill_type_id"," checked");
//	write search options
$options="";
$options.="<OPTION VALUE=\"Equals\" ".(($opt=="Equals")?"selected":"").">"."Equals"."</option>";
$searchtype = "<SELECT ID=\"SearchOption\" NAME=\"asearchopt_skill_type_id\" SIZE=1 onChange=\"return ShowHideControls();\">";
$searchtype .= $options;
$searchtype .= "</SELECT>";
$smarty->assign("searchtype_skill_type_id",$searchtype);
//	edit format
$editformats["skill_type_id"]="Lookup wizard";
// skill_subtype_id 
$opt="";
$not=false;
if(@$_SESSION[$strTableName."_search"]==2)
{
	$opt=@$_SESSION[$strTableName."_asearchopt"]["skill_subtype_id"];
	$not=@$_SESSION[$strTableName."_asearchnot"]["skill_subtype_id"];
	$smarty->assign("value_skill_subtype_id",@$_SESSION[$strTableName."_asearchfor"]["skill_subtype_id"]);
	$smarty->assign("value1_skill_subtype_id",@$_SESSION[$strTableName."_asearchfor2"]["skill_subtype_id"]);
}	
if($not)
	$smarty->assign("not_skill_subtype_id"," checked");
//	write search options
$options="";
$options.="<OPTION VALUE=\"Equals\" ".(($opt=="Equals")?"selected":"").">"."Equals"."</option>";
$searchtype = "<SELECT ID=\"SearchOption\" NAME=\"asearchopt_skill_subtype_id\" SIZE=1 onChange=\"return ShowHideControls();\">";
$searchtype .= $options;
$searchtype .= "</SELECT>";
$smarty->assign("searchtype_skill_subtype_id",$searchtype);
//	edit format
$editformats["skill_subtype_id"]="Lookup wizard";
// skill_note 
$opt="";
$not=false;
if(@$_SESSION[$strTableName."_search"]==2)
{
	$opt=@$_SESSION[$strTableName."_asearchopt"]["skill_note"];
	$not=@$_SESSION[$strTableName."_asearchnot"]["skill_note"];
	$smarty->assign("value_skill_note",@$_SESSION[$strTableName."_asearchfor"]["skill_note"]);
	$smarty->assign("value1_skill_note",@$_SESSION[$strTableName."_asearchfor2"]["skill_note"]);
}	
if($not)
	$smarty->assign("not_skill_note"," checked");
//	write search options
$options="";
$options.="<OPTION VALUE=\"Contains\" ".(($opt=="Contains")?"selected":"").">"."Contains"."</option>";
$options.="<OPTION VALUE=\"Equals\" ".(($opt=="Equals")?"selected":"").">"."Equals"."</option>";
...
$options.="<OPTION VALUE=\"Between\" ".(($opt=="Between")?"selected":"").">"."Between"."</option>";
$options.="<OPTION VALUE=\"Empty\" ".(($opt=="Empty")?"selected":"").">"."Empty"."</option>";
$searchtype = "<SELECT ID=\"SearchOption\" NAME=\"asearchopt_skill_note\" SIZE=1 onChange=\"return ShowHideControls();\">";
$searchtype .= $options;
$searchtype .= "</SELECT>";
$smarty->assign("searchtype_skill_note",$searchtype);
//	edit format
$editformats["skill_note"]=EDIT_FORMAT_TEXT_FIELD;
// skill_hourly 
$opt="";
$not=false;
if(@$_SESSION[$strTableName."_search"]==2)
{
	$opt=@$_SESSION[$strTableName."_asearchopt"]["skill_hourly"];
	$not=@$_SESSION[$strTableName."_asearchnot"]["skill_hourly"];
	$smarty->assign("value_skill_hourly",@$_SESSION[$strTableName."_asearchfor"]["skill_hourly"]);
	$smarty->assign("value1_skill_hourly",@$_SESSION[$strTableName."_asearchfor2"]["skill_hourly"]);
}	
if($not)
	$smarty->assign("not_skill_hourly"," checked");
//	write search options
$options="";
$options.="<OPTION VALUE=\"Contains\" ".(($opt=="Contains")?"selected":"").">"."Contains"."</option>";
$options.="<OPTION VALUE=\"Equals\" ".(($opt=="Equals")?"selected":"").">"."Equals"."</option>";
...
$options.="<OPTION VALUE=\"Between\" ".(($opt=="Between")?"selected":"").">"."Between"."</option>";
$options.="<OPTION VALUE=\"Empty\" ".(($opt=="Empty")?"selected":"").">"."Empty"."</option>";
$searchtype = "<SELECT ID=\"SearchOption\" NAME=\"asearchopt_skill_hourly\" SIZE=1 onChange=\"return ShowHideControls();\">";
$searchtype .= $options;
$searchtype .= "</SELECT>";
$smarty->assign("searchtype_skill_hourly",$searchtype);
//	edit format
$editformats["skill_hourly"]="Text field";
// prof_provider 
$opt="";
$not=false;
if(@$_SESSION[$strTableName."_search"]==2)
