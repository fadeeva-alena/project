...
if (isset($_GET['searchFor']) && postvalue('searchFor') != '') {
	...
	$searchField = GoodFieldName( postvalue('searchField') );
				...
				if ( $searchField == '' || $searchField=="searchid")
	{
		$field="searchid";
		...
		$rs=db_query($strSQL,$conn);
			...
			if ( $searchField == '' || $searchField=="Search_type")
	{
		$field="Search_type";
		if(CheckFieldPermissions($field))
		{
			...
			if ( $searchField == '' || $searchField=="Username")
	{
		...
		$rs=db_query($strSQL,$conn);
			...
			if ( $searchField == '' || $searchField=="Skill_type")
	{
		$field="Skill_type";
		if(CheckFieldPermissions($field))
		{
		...
		$rs=db_query($strSQL,$conn);
			...
			if ( $searchField == '' || $searchField=="Skill_Subtype")
	{
		$field="Skill_Subtype";
		if(CheckFieldPermissions($field))
		{
