...
?>
<input type=button value="Häufige Fragen" onclick=location.href="faq.php" id="helpbtn6">
<input type=button value="Über uns" onclick=location.href="about.php" id="aboutbtn1">
...
echo"<input type='button' value='Suche' onclick=location.href='search.php?kinder={$row1['Skill_type']}&type={$t}&gender={$g}&ke={$ke}' id='maindatbtn'>";
}
else
