...
if($_POST["f2s"] == 1){
  ...
  $to = 'info@piletpartner.ch, Technik@ManiMano.ch ,'.$row['email'];
  //$to = $row['email'];
  $subject = 'Offertanfrage für Haftpflichtversicherung';
...
$message .='Sehr geehrter Herr Pilet<br><br> ';
$message.='Untenstehender ManiMano-Teilnehmer wünscht eine Offerte per Email:<br>';
...
$message.='<p>Wichtiger Hinweis: Alle Vertragsverhältnisse werden zwischen den beteiligten
Parteien abgewickelt. ManiMano ist nicht Vertragspartei, sondern stellt
lediglich die Plattform zur Verfügung, und ist in keinem Fall haftbar.
(V.3.8.11) </p><br>';
...
$j="Danke für Ihre Nachricht, diese wurde ausgeliefert.";
$visitor = ""; 
$visitormail = ""; 
$notes = "";
$attn = "";
	  ...
	  <div class="row help_tbl">
        <div class="col-md-6">
          ...
          <div class="col-md-6">
            ...
            echo "* Diese Dokumente sind erst nach Anmeldung verfübar. <br>";
            ...
            <form id="form2" name="form2" method="post" action="help.php" >
              ...
              echo"<p>";
              echo"<a href='javascript: submitform()' >Klicken Sie hier</a>, wird mit Ihren persönlichen Daten direkt eine Offertanfrage vom Versicherungsmakler Pilet von Pilet-Partner eingeholt. Sie erhalten eine Kopie des Emails.</p>";

              } else
              {
              echo"<strong>Privathaftpflicht (erst nach Anmeldung verfügbar)
              </strong><br>";
              echo"<p>";
              echo"Klicken Sie hier, wird mit Ihren persönlichen Daten direkt eine Offertanfrage von Versicherungsmakler Pilet von Pilet-Partner eingeholt. Sie erhalten eine Kopie des Emails.</p>";
