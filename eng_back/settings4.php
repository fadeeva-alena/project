...
if($_POST["nextbtn"] == "Weiter zu lhren persönlichen Eigenschaften (5 von 6)"  )
{
$Nv=$_POST['Nv'];
...
<input type=button value="Rechtliches" onclick=location.href="Rechtliches.php" id="helpbtn3">
	...
	<input type=button value="Meine Daten" onclick=location.href="settings3.php" id="maindatbtn">
	<?php
...
</map>		<span id="title">4) Bedürfnisprofil: <img src="images/page4.png" usemap="#green"  border="0" align="right" /> </span>
...
<input type="hidden" Name="Nv"  id="Nv" value="<?php echo"$Nv";?>">
      <p><input type="submit" name="nextbtn" id="nextbtn1" value="Weiter zu lhren persönlichen Eigenschaften (5 von 6)" onclick=location.href="settings5.php" /></p>
</form>
    </div>
  </div>
</div>
