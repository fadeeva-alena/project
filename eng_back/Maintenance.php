...
<div id="container">
  <div class="header">
	...
	<input type=button value="Register" onclick=location.href="register1.php?al=''&im=''" id="regbtn" DISABLED>
	<input type=button value="Login" onclick=location.href="login.php?al=2" id="loginbtn"DISABLED>
	<input type=button value="Help" onclick=location.href="help.php" id="helpbtn"DISABLED>
  </div>
