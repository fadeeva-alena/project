...
if($_POST["nextbtn"] == "Weiter zum Bedürfnisprofil (4 von 6)"  )
{
$Nv=$_POST['Nv'];
...
<input type=button value="Rechtliches" onclick=location.href="Rechtliches.php" id="helpbtn3">
	...
	<input type=button value="Meine Daten" onclick=location.href="settings2.php" id="maindatbtn">
	<?php
...
?>
  ...
  <div class="mainContent">
	<div class="content">
		<span id="title">3) Angebotsprofil:  <img src="images/page3.png" border="0"  usemap="#green" align="right" /></span>
<map name="green">
...
<input type="hidden" Name="Nv"  id="Nv" value="<?php echo"$Nv";?>">
      <p><input type="submit" name="nextbtn" id="nextbtn" value="Weiter zum Bedürfnisprofil (4 von 6)" onclick=location.href="settings4.php" /></p>
</form>
    </div>
  </div>
</div>
